...
Generated: 2026-09-25 22:59 UTC

当前展示 166 篇论文的最新版本。旧版本只保留 arXiv 链接。
...
<table style="table-layout: fixed; width: 100%;">
  ...
  <tbody>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>1. Sim-to-Real Aware End-to-End Learning Environment for Micromobility</strong><br><span>Shouma Amano, Takuya Azumi</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-09-24</div><div>2026-09-24</div><div><a href="http://arxiv.org/abs/2609.28969v1">2609.28969v1</a> / <a href="https://arxiv.org/pdf/2609.28969v1">PDF</a></div><div>cs.RO</div></td>
      <td style="width: 10%; vertical-align: top;">world model</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>尽管端到端自动驾驶系统展现出了潜力，但模拟器无法捕捉差速驱动和全向轮等特定运动学特性，这阻碍了其在微移动车辆上的应用。本文提出了一个面向WHILL Model CR车辆的、具备仿真到现实（sim-to-real）感知能力的端到端学习环境，该环境基于AWSIM和ROS 2构建。为了最小化仿真与现实之间的差距，研究利用真实世界数据通过贝叶斯优化调整物理参数，从而降低了各种驾驶场景下的轨迹误差。此外，本文引入了一种为基于世界模型的智能体稳定训练而设计的同步架构。在模拟避障设置中，使用DreamerV3训练的端到端策略表现出了学习进展并实现了任务完成。进一步地，该策略展示了从仿真到实体车辆的直接迁移能力，使车辆能够在无需微调的情况下，在现实世界的走廊复制环境中绕过纸箱导航。本文为微移动仿真到现实策略的研究提供了实践基础。</td>
      <td style="width: 20%; vertical-align: top;">针对微移动车辆仿真与现实差距大的问题，本文构建了一个基于AWSIM和ROS 2的专用端到端学习环境，通过贝叶斯优化对物理参数进行校准。研究引入了同步架构以支持基于世界模型的智能体稳定训练，并成功实现了DreamerV3策略从模拟环境到物理车辆的无微调迁移。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>2. AnchorReasoning: A Visual Grounding and Causal Reasoning Dataset in Long-Tail Autonomous Driving Scenarios</strong><br><span>Zhipeng Bao, Wenjie Zhao, Tianle Zhu, Haohua Que, Chence Yang, Geng Yuan, Qianwen Li</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-09-23</div><div>2026-09-23</div><div><a href="http://arxiv.org/abs/2609.28366v1">2609.28366v1</a> / <a href="https://arxiv.org/pdf/2609.28366v1">PDF</a></div><div>cs.CV, cs.AI</div></td>
      <td style="width: 10%; vertical-align: top;">VLM</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>视觉语言模型（VLM）为长尾自动驾驶提供了一种有前景的方案，但现有的驾驶数据集在连接决策关键的视觉证据与推理规划方面提供的监督有限。我们介绍了 AnchorReasoning，这是一个基于 WOD-E2E 构建的视觉基础推理数据集，包含 416,119 帧标注数据和涵盖四大类及 19 个细分类型的 395,379 个决策关键元素。每一帧均组织为视觉基础思维链（VG-CoT），将决策关键元素的识别与定位、元素属性与影响、驾驶行为原理以及动作与轨迹规划联系起来。我们进一步开发了一种课程监督微调策略，逐步学习这些层次化能力，并提出了一种用于评估定位质量的目标尺寸感知基础指标。在八种通用、具身 AI 和自动驾驶专用主干网络上的实验表明，VG-CoT 监督改善了基础推理和轨迹预测效果。在各模型中，5 秒的 ADE 和 FDE 分别降低了 7.84 和 11.86，而 RFS Frame 和 Cluster 分别提升了 1.66 和 1.70。这些性能增益是在平均减少 18.5 个推理 token 和降低 0.32 秒/帧推理延迟的情况下实现的，证明了以决策为中心的视觉基础监督对于长尾自动驾驶中 VLM 推理和规划的价值。</td>
      <td style="width: 20%; vertical-align: top;">针对长尾自动驾驶场景中缺乏决策关键视觉推理数据的问题，本研究提出了 AnchorReasoning 数据集，构建了包含视觉基础思维链的层次化标注体系。通过采用课程监督微调策略和目标尺寸感知评估指标，该方法有效提升了视觉语言模型在复杂驾驶任务中的推理精度与轨迹预测性能，同时降低了推理延迟。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>3. ForeDrive: Foresight-Guided End-to-End Autonomous Driving with a Planning-Relevant Latent World Model</strong><br><span>Sinuo Wang, Zichong Gu, Yuhan Huang, Wenxin Wen, Xun Yang, Yiqing Zhang, Xingyu Zhang, Ningyu Che, Jie Ling, Qiankun Yu, Wei Liu, Jing Xu, Xinggang Wang</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-09-22</div><div>2026-09-23</div><div><a href="http://arxiv.org/abs/2609.26299v2">2609.26299v2</a> / <a href="https://arxiv.org/pdf/2609.26299v2">PDF</a></div><div class="old-versions">旧版：<a href="http://arxiv.org/abs/2609.26299v1">v1</a></div><div>cs.CV</div></td>
      <td style="width: 10%; vertical-align: top;">world model, RL</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>现有的潜在世界模型通常针对未来可预测性进行优化，但由此生成的表征并不一定对自动驾驶的规划任务有用。预测通常用于预训练或辅助监督，而非作为轨迹生成的直接条件信号。我们提出了 ForeDrive，它学习了一种与规划相关的潜在表征，并将其非对称地耦合到扩散变换器（DiT）规划器中。该规划器利用 JEPA 风格的世界模型学习的多视界潜在未来表征；规划梯度更新共享的在线编码器，同时通过停止梯度路由仅利用预测损失来训练潜在预测器。由于预测的未来在不同视界下可靠性不一，且鸟瞰图（BEV）轨迹与图像标记未对齐，我们采用了门控视觉融合、未来状态注入和轨迹自适应偏差（TAB）技术，在不覆盖当前观测的情况下引入未来潜在表征作为引导。ForeDrive 仅通过纯模仿学习进行训练，且在推理时仅使用当前的正面视角图像作为视觉输入，在 NAVSIM v1 上达到了 89.9 的 PDMS 分数，在 NAVSIM v2 上达到了 90.0 的单阶段 EPDMS 分数，且无需强化学习或外部轨迹评分器。</td>
      <td style="width: 20%; vertical-align: top;">针对现有世界模型表征对规划任务支持不足的问题，本文提出了 ForeDrive，通过将与规划相关的潜在表征与扩散规划器非对称耦合，提升了预测信息的利用效率。该方法引入了门控视觉融合与轨迹自适应偏差等机制，使规划器能有效融合未来预测信息，在无需强化学习的情况下实现了高性能的端到端自动驾驶。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>4. ZYT-World: A Real-Time Controllable World Model for Closed-Loop Autonomous-Driving Simulation</strong><br><span>Boni Hu, Xiong Wei, Haoming Huang, Yong Huang, Chenbo Wang, Yi Yang, Jiancheng Wang, Ruicheng Zhu, Zhimin Yang, Guanglai Liu, Qiaowan Jin, Dongzhuo Wang, Haiwei Kuang, Jiajun Fan, Yue Wu, Jiaxin Wei, Hao Sun, Feihong Yan, Yuyao Zhou, Wei Bi, Kaixuan Wang, Zichao Guo, Xiaozhi Chen</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-09-18</div><div>2026-09-22</div><div><a href="http://arxiv.org/abs/2609.21712v2">2609.21712v2</a> / <a href="https://arxiv.org/pdf/2609.21712v2">PDF</a></div><div class="old-versions">旧版：<a href="http://arxiv.org/abs/2609.21712v1">v1</a></div><div>cs.CV</div></td>
      <td style="width: 10%; vertical-align: top;">world model, distillation</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>生成式世界模型为端到端及视觉-语言-动作驾驶策略提供了可控且可重复的闭环仿真，但实际部署中存在三个未解决的需求：忠实地以原生分辨率重现鱼眼和针孔混合相机阵列；协调因果化的单步交互与长时稳定性及低延迟；以及在重访地点时保持场景身份的一致性。我们提出了ZYT-World，这是一种单一架构，可原生生成四个视场角大于180°的鱼眼视图和三个针孔视图。投影特定的Plucker适配器编码相机几何结构，自我运动自适应层归一化提供全局运动控制，轻量级的像素对齐布局通过实例级边框、朝向和颜色来调节交通参与者和信号。异构训练结合了全阵列几何覆盖与高分辨率细节。通过教师强制、因果一致性蒸馏、自我滚存分布匹配蒸馏和RigCritic评估，我们将40步双向教师模型转化为单步潜空间流式生成器，并由RigCritic对七视图阵列进行联合评估。1900万参数的变分自编码器解码器（TinyVAE）、W8A8量化以及推理引擎分别降低了解码、主干网络和增量执行成本。最后，源自真实采集的跨轨迹对训练了一个插件式隐式记忆模块，以保留特定地点的证据。在内部多视图测试集上，单步模型保留了超过90%的教师模型PSNR和SSIM，而FID、FVD和LPIPS指标保持在教师模型的11%以内。在仅考虑生成器的时间测试中，其速度比40步双向教师模型快107.7倍。TinyVAE的解码速度比Wan快59.8倍。30秒的滚存测试和跨轨迹重访展示了预期的长时性能和记忆行为。</td>
      <td style="width: 20%; vertical-align: top;">针对自动驾驶闭环仿真中多相机阵列生成面临的分辨率、延迟及记忆一致性挑战，本文提出了ZYT-World模型。该方法通过采用投影适配器、轻量级布局调节以及多种蒸馏技术，实现了高效的单步流式多视角图像生成。实验结果表明，该架构在保持高画质的同时显著提升了推理速度，并具备良好的长时稳定性与场景记忆能力。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>5. OPTED: On-Policy Fine-Tuning for End-to-End Driving using a Render-Free Teacher</strong><br><span>Damiano Da Col, Maximilian Igl, Peter Karkus, Kashyap Chitta, Boris Ivanovic, Marco Pavone, Konrad Schindler, Christos Sakaridis</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-09-17</div><div>2026-09-17</div><div><a href="http://arxiv.org/abs/2609.20756v1">2609.20756v1</a> / <a href="https://arxiv.org/pdf/2609.20756v1">PDF</a></div><div>cs.RO, cs.CV, cs.LG</div></td>
      <td style="width: 10%; vertical-align: top;">RL</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>由于仅增加预训练数据规模带来的收益递减，后训练在自动驾驶等物理人工智能领域变得日益重要。端到端驾驶策略通常在开环环境下通过行为克隆人类示范进行预训练。然而，闭环部署期间的累积误差可能导致车辆脱离训练数据分布，从而增加发生安全事故的风险。虽然闭环后训练可以缓解这一风险，但对于基于传感器的策略而言，这需要昂贵的仿真支持。我们提出了 OPTED（一种用于端到端驾驶的同策略微调方法），它将强化学习从端到端策略的后训练中解耦：利用特权教师模型在向量化输入（高清地图和边界框）上进行强化学习训练，随后该教师在闭环后训练过程中为预训练的学生模型提供监督。我们将 OPTED 应用于 TransFuser 和 VaVAM 两个基于摄像头的模型，并利用真实驾驶日志的神经重建（3DGS）在 AlpaSim 中对其进行微调。实验结果显示，驾驶得分分别提升了 1.6 倍和 9.5 倍。受控实验表明，OPTED 在闭环性能上与直接强化学习后训练相当，但所需的模拟器交互次数减少了约三个数量级，同时能更好地保持人类先验。</td>
      <td style="width: 20%; vertical-align: top;">针对端到端自动驾驶模型在闭环部署中的累积误差问题，本文提出了一种名为 OPTED 的同策略微调方法。该方法通过引入基于向量化输入的特权教师模型来指导学生模型的闭环后训练，显著降低了仿真需求并提升了驾驶性能。实验证明，该方法在保持人类先验的同时，能以极高的效率显著增强现有模型的驾驶表现。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>6. MILER: Semantic Mid-Level Representation for Sim-to-Real Reinforcement Learning in Unstructured Autonomous Driving</strong><br><span>Thomas Steinecker, Denis Trescher, Alexander Bienemann, Thorsten Luettel, Mirko Maehlisch</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-09-17</div><div>2026-09-17</div><div><a href="http://arxiv.org/abs/2609.20747v1">2609.20747v1</a> / <a href="https://arxiv.org/pdf/2609.20747v1">PDF</a></div><div>cs.RO, cs.LG</div></td>
      <td style="width: 10%; vertical-align: top;">RL</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>强化学习因其具备超越人类表现的潜力和自主学习策略的能力，成为一种极具前景的方法。然而，由于非结构化环境在模拟到真实（Sim-to-Real）迁移方面存在挑战，强化学习在非结构化自主驾驶中的应用依然稀缺。本研究提出了 MILER，一个支持零样本（Zero-shot）模拟到真实迁移的端到端策略框架。在离线训练阶段，我们利用自定义的语义中级表示（MLR）模拟器，通过强化学习训练策略网络，并将控制输出直接应用于自行车模型。在真实车辆部署阶段，通过 BEVFusion 处理摄像头和激光雷达数据，生成与 MLR 模拟器一致的语义鸟瞰图表示。策略网络生成的动作并非直接作用于真实车辆，而是采用轨迹对齐策略，实现了感知与控制的零样本模拟到真实迁移。我们在包含多种障碍物、发夹弯、高达 33.6 km/h 的速度及越野路段等多挑战的测试轨道上对该框架进行了广泛评估。实验中，我们在 3.0 公里的测试轨道上使用两辆不同的车辆完成了 17.3 公里的无人干预驾驶，验证了该方法的有效性。此外，整套软件栈均可在 Jetson AGX Orin 上运行。</td>
      <td style="width: 20%; vertical-align: top;">针对非结构化环境自主驾驶在模拟到真实迁移中的挑战，本文提出了 MILER 框架。该方法通过引入语义中级表示和轨迹对齐策略，实现了感知与控制的零样本迁移，并在实车测试中表现出良好的自动驾驶性能。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>7. RAF-VLA: Representation Alignment with the Future for End-to-End Autonomous Driving</strong><br><span>Dogun Kim, Yongjae Lee, Joonhee Lim, Yeina Lee, Junhyeok Park, Moogeun Park, Dongsuk Kum</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-09-15</div><div>2026-09-15</div><div><a href="http://arxiv.org/abs/2609.17728v1">2609.17728v1</a> / <a href="https://arxiv.org/pdf/2609.17728v1">PDF</a></div><div>cs.RO</div></td>
      <td style="width: 10%; vertical-align: top;"></td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>近期用于自动驾驶的视觉-语言-动作（VLA）模型通过在预测驾驶动作的同时预测未来驾驶场景来整合世界模型，展现出了强大的规划性能。未来驾驶场景被用作密集监督信号，鼓励策略学习对规划有用的丰富内部表示。然而，这些世界建模型VLA依赖于显式的未来生成来学习此类表示，从而引入了两个关键限制：额外的训练负担和推理延迟。为了解决这些限制，我们提出了RAF-VLA（Representation Alignment with the Future），这是一种基于VLA的自动驾驶框架，通过来自未来帧表示的直接引导来塑造与规划相关的内部表示。RAF-VLA采用了“未来对齐监督微调”方法，通过一种简单的正则化手段，在学习驾驶动作的同时，将策略的隐藏状态与从预训练世界编码器获得的未来帧表示进行对齐。这种简单的对齐方式使RAF-VLA避免了与未来生成相关的训练负担和推理延迟。在NAVSIM基准测试上的大量实验表明，RAF-VLA在训练样本量显著减少的情况下，达到了与最先进的VLA规划器相当的规划性能。此外，RAF-VLA仅产生了3.8%的训练开销和可忽略不计的1毫秒推理开销。</td>
      <td style="width: 20%; vertical-align: top;">针对现有世界建模型VLA自动驾驶模型依赖显式未来生成带来的计算负担和延迟问题，该论文提出了RAF-VLA框架。该方法通过将策略隐藏状态与预训练世界编码器的未来帧表示进行直接正则化对齐，在无需生成未来场景的情况下有效提升了规划性能。实验结果证明，该方法在显著降低训练和推理开销的同时，保持了与主流模型相当的规划效果。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>8. DriveZero: End-to-End Driving Beyond Human Demonstrations</strong><br><span>Hao He, Chengcheng Hu, Zirun Su, Heng Zhang, Haisong Liu, Jinke Li, Haochen Tian, Zhenwei Shen, Hongyang Li, Zhichao Li, Yunchen Yang, Bochao Huang, Siyu Zhang, Kuangye Chen, Xiongjie Zhang, Wentao Dai, Hengchen Dai, Siyuan Liu, Zehao Huang, Naiyan Wang</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-09-05</div><div>2026-09-05</div><div><a href="http://arxiv.org/abs/2609.06055v1">2609.06055v1</a> / <a href="https://arxiv.org/pdf/2609.06055v1">PDF</a></div><div>cs.CV</div></td>
      <td style="width: 10%; vertical-align: top;">RL</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>大多数端到端自动驾驶系统通过模仿人类驾驶日志进行学习，导致其习得行为受限于记录轨迹的质量和覆盖范围。本报告提出了 DriveZero，这是一个超越人类演示学习驾驶行为的端到端系统。它将驾驶分解为感知模型和动作模型，分别在各自最适用的领域进行预训练，并将其结合为一个端到端规划器。这两个模型需要不同的学习方法：感知模型必须理解世界，受益于大规模且多样化的视觉数据；动作模型必须与世界交互，需要闭环反馈。在动作方面，我们引入了 DriveRL，这是一个混合智能体闭环强化学习框架。它将真实驾驶日志转化为交互式世界，并通过闭环演练利用 PPO 训练特权教师策略。在感知模型方面，DriveVFM 仅通过原始图像将多个冻结的视觉基础模型（包括 DINOv3、SigLIP2、SAM 和 Depth Anything V2）整合为单一主干，无需任何特定任务的标注。DriveZero 随后统一了这两者：一个仅依赖摄像头的规划器，通过其演练轨迹提炼冻结的 DriveRL 教师模型。该目标条件教师还可以在增强驾驶意图下进行查询，提供记录数据无法实现的、多样且目标一致的监督信号。在 nuPlan 上，DriveRL 配合价值引导的测试时动作搜索，在 Val14、Test14-hard 和 Test14-random 社区划分的非响应和响应模式下均取得了 93.57 的平均分，在所有三个划分上均超过了 Log-Replay 专家模型。DriveZero 在无需任何人际轨迹监督的情况下，在 NAVSIMv1、NAVSIMv2 和闭环 HUGSIM 基准测试中实现了最先进的性能。</td>
      <td style="width: 20%; vertical-align: top;">针对端到端自动驾驶受限于人类演示质量的问题，本文提出了 DriveZero 系统，将感知与动作模型分开预训练并整合为闭环规划器。该方法通过引入闭环强化学习框架 DriveRL 和视觉基础模型整合方案 DriveVFM，实现了无需人类轨迹监督的训练。实验结果表明，DriveZero 在多个主流自动驾驶基准测试中均达到了最先进的性能水平。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>9. Continuous Actions from Discrete Minds: Latent-Aligned Planning for End-to-End Autonomous Driving</strong><br><span>Ruoyu Yao, Yusen Xie, Qingzhao Liu, Pei Liu, Zewei Yang, Yipeng Zhu, Xiaolong Wang, Jun Ma</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-09-03</div><div>2026-09-03</div><div><a href="http://arxiv.org/abs/2609.04070v1">2609.04070v1</a> / <a href="https://arxiv.org/pdf/2609.04070v1">PDF</a></div><div>cs.CV, cs.RO</div></td>
      <td style="width: 10%; vertical-align: top;">VLM</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>弥合视觉语言模型（VLM）的离散推理与自动驾驶中物理约束连续性之间的差距仍然是一项重大挑战。在这项工作中，我们介绍了LaPla，这是一个统一的视觉-语言-行动（VLA）框架，其特征在于潜在对齐规划（latent-aligned planning），能够将语义理解无缝地基础于精确的运动执行中。我们首先设计了一种基于残差向量量化变分自编码器（VQ-VAE）的动作分词器，旨在捕捉车辆运动学并将轨迹特征编码到结构化的潜在空间中。LaPla并没有依赖会导致量化误差的离散码本查找，而是将这种表征重新用作物理先验，以弥合高维语义与原始行动空间之间的模态差距。具体而言，给定集成了多视图图像、历史动作和文本指令的多模态输入，LaPla结合了并发动作查询，在单次前向传递中因果地关注多模态上下文，并将隐藏状态直接投影到预训练的VQ-VAE潜在空间中。随后，冻结的解码器将这些连续的潜在变量转化为动作，有效消除了量化误差并确保了物理上合理的轨迹，同时避开了耗时的自回归生成。在nuScenes基准测试上的广泛实验表明，LaPla实现了具有竞争力的开环性能，与最先进的VLA方法相比，将长程L2误差降低了15.52%。在NVIDIA AlpaSim模拟器上的闭环评估进一步证实了其在确保平稳驾驶进度方面的卓越能力，成功率提高了33.34个百分点，并显著降低了推理延迟。</td>
      <td style="width: 20%; vertical-align: top;">针对视觉语言模型难以直接输出符合物理约束的自动驾驶动作问题，本文提出了LaPla框架。该方法通过设计基于VQ-VAE的动作分词器实现潜在对齐规划，将多模态语义直接映射到连续的动作潜在空间。实验结果表明，该方法在减少计算延迟的同时，显著提升了自动驾驶轨迹预测的精确度与成功率。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>10. SV-WAM: An Efficient Surround-View World-Action Model for End-to-End Autonomous Driving</strong><br><span>Jinyang Wang, Shiwei Li, Junjian Wang, Zhiqiang Deng, Jianbin Gao, Yihang Zhao, Liu Liu, Yongjia Zhao, Jinlong Chen, Huirui Xu, Yifeng Pan, Kangwei Liu, Fan Ren, Ji Tao, Minghao Yang</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-09-03</div><div>2026-09-03</div><div><a href="http://arxiv.org/abs/2609.03602v1">2609.03602v1</a> / <a href="https://arxiv.org/pdf/2609.03602v1">PDF</a></div><div>cs.CV, cs.RO</div></td>
      <td style="width: 10%; vertical-align: top;">world model</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>世界模型（WMs）通过学习未来场景动态的预测表示，在端到端自动驾驶领域展现出巨大潜力。然而，在推理过程中生成未来视频会引入巨大的计算开销，导致许多近期的驾驶世界模型为了高效部署而仅采用单前置摄像头作为输入。这种设计限制了在变道、合流和转弯等安全关键场景下的空间覆盖能力。为了解决这一局限性，我们提出了SV-WAM，这是一种在保持高效推理的同时保留全六目摄像头观测的环视世界-动作模型（WAM）。SV-WAM利用未来视频预测作为共享生成模型内部动作学习的密集训练监督，而不是作为推理时的输出。该设计的核心是一个以动作为中心的因果掩码，它在联合动作-视频去噪过程中阻止动作标记关注未来视频标记。因此，视频分支可以在部署时被丢弃，从而实现高效的纯动作规划。此外，我们引入了一种可微的可行驶区域合规正则化器，用于惩罚接近或越过可行驶边界的车辆足迹角，从而提高了规划的安全性和边界感知能力。在闭环NAVSIMv2基准测试和开环nuScenes基准测试上的广泛实验表明，SV-WAM以较低的推理延迟实现了最先进的规划性能，并具备卓越的零样本迁移能力。</td>
      <td style="width: 20%; vertical-align: top;">针对现有端到端自动驾驶世界模型在环视覆盖与计算效率之间的权衡问题，本文提出了一种名为SV-WAM的高效环视世界-动作模型。该模型通过在训练中引入视频预测作为监督信号，并配合以动作为中心的因果掩码，实现了在推理阶段仅输出动作规划的轻量化部署。实验表明，该方法在保证较低延迟的同时，显著提升了驾驶规划的安全性与性能。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>11. Long-Horizon Consistent and Interaction-Aware World Models for Multi-Style End-to-End Driving</strong><br><span>Yuxuan Han, Kunyuan Wu, Liyunong Yang, Zilu Wang, Cansen Jiang, Yi Xiao, Liang Hu</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-09-03</div><div>2026-09-03</div><div><a href="http://arxiv.org/abs/2609.03225v1">2609.03225v1</a> / <a href="https://arxiv.org/pdf/2609.03225v1">PDF</a></div><div>cs.RO</div></td>
      <td style="width: 10%; vertical-align: top;">world model, RL</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>端到端自动驾驶越来越多地采用基于世界模型的强化学习框架，通过“想象回放”（imagined rollouts）来提高学习效率。然而，现有的世界模型存在三个主要局限：长程想象回放中的时间不一致性、对自我-环境交互建模不足，以及对多样化驾驶风格的适应性有限。为了应对这些挑战，我们提出了 StyleDrive，这是一个基于世界模型的学习框架，在统一的学习范式下同时实现了长程一致性、显式解耦的交互交通状态，并支持多风格策略优化。首先，我们引入了一种时间一致性正则化方法，通过门控交叉注意力机制整合历史潜在状态，从而稳定长程想象回放并减轻误差累积。其次，我们设计了一个显式状态解耦模块，将与自我相关的交互状态与无关状态分离开来，使得在复杂交通场景下的决策更具可解释性和效率。第三，我们通过群组相对策略优化实现了多风格驾驶行为，用轨迹级相对优势取代了单步奖励优化，在无需重训的情况下降低了奖励方差并支持了多种驾驶风格。我们在 Bench2Drive 闭环驾驶基准上评估了 StyleDrive，获得了 88.44 的驾驶评分（较之前最好的基于世界模型的方法提升了 17.08）和 66.82 的成功率（提升了 16.58）。此外，我们将 StyleDrive 部署在真实的自动导引车平台上，展示了其在动态驾驶场景中良好的模拟到现实（sim-to-real）迁移能力。</td>
      <td style="width: 20%; vertical-align: top;">针对现有自动驾驶世界模型在长程一致性、交互建模及风格适应性上的不足，本文提出了 StyleDrive 框架。该方法通过引入时间一致性正则化、显式状态解耦模块以及群组相对策略优化，显著提升了驾驶决策的稳定性和多样性。实验证明该方法在闭环基准测试中表现卓越，并具备良好的实车迁移潜力。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>12. Roadside-Cooperative Autonomous Driving: From Data Platform to Vision-Language End-to-End Reasoning</strong><br><span>Yitao Xu, Tong Wu, Yiyan Wu, Guoji Xu, Yanbo Jiang, Jiahao Wang, Zehong Ke, Junkai Jiang, Fang Zhang, Jianqiang Wang</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-08-21</div><div>2026-08-21</div><div><a href="http://arxiv.org/abs/2608.21032v1">2608.21032v1</a> / <a href="https://arxiv.org/pdf/2608.21032v1">PDF</a></div><div>cs.RO</div></td>
      <td style="width: 10%; vertical-align: top;">VLM</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>车路协同（V2X）技术能够实现视距外感知，缓解单车感知中的遮挡问题。然而，现有的 V2X 基准测试对闭环评估和语言引导监督的支持有限，阻碍了用于端到端协同驾驶的视觉语言模型（VLM）的发展。为了解决这些限制，我们推出了 V2XBench，这是一个具有同步车端-路侧感知和闭环评估功能的仿真平台，以及 Chat-V2XBench，一个用于协同推理的渐进式结构化视觉问答（VQA）数据集。基于这一基准设施，我们提出了 AURORA，这是一个端到端协同驾驶框架。AURORA 配备了双视角感知架构，通过查询级跨视角查询对齐与融合（CQAF）模块，缓解了车端和路侧视角之间的空间和语义差异。利用生成的统一 Token，经过 LoRA 微调的 VLM 能够连接语义推理与生成式轨迹规划。在 V2XBench 上进行的广泛闭环评估表明，AURORA 在严重遮挡场景下达到了最先进的性能，路径完成率为 98.21%，驾驶评分为 76.02，同时仅需较低的路侧通信带宽。总之，这项工作开创了一种可扩展的 V2X-VLM 范式，为下一代协同自动驾驶铺平了道路。</td>
      <td style="width: 20%; vertical-align: top;">针对现有车路协同基准测试在闭环评估与语言监督方面的不足，本文提出了 V2XBench 仿真平台及 Chat-V2XBench 数据集。在此基础上，研究团队设计了名为 AURORA 的端到端协同驾驶框架，通过跨视角融合与视觉语言模型实现了高效的推理与轨迹规划。实验证明，该方法在严重遮挡环境下显著提升了驾驶性能，且具备低带宽通信的优势。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>13. Planning-Oriented End-to-End Autonomous Driving: Architectures, Evaluation, and Emerging Paradigms</strong><br><span>Yanchen Guan, Xingcheng Liu, Bin Rao, Chengyue Wang, Guofa Li, Yunjian Li, Lishengsa Yue, Zhiyong Cui, Chengzhong Xu, Zhenning Li</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-08-20</div><div>2026-08-20</div><div><a href="http://arxiv.org/abs/2608.20111v1">2608.20111v1</a> / <a href="https://arxiv.org/pdf/2608.20111v1">PDF</a></div><div>cs.RO, cs.ET</div></td>
      <td style="width: 10%; vertical-align: top;">world model, distillation</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>端到端自动驾驶已从摄像头到控制的回归模型，演变为使用结构化表征、轨迹级输出以及日益逼真的评估协议的规划导向系统。本综述回顾了这一转变过程，涵盖了行为克隆、条件模仿学习、特权蒸馏、BEV与向量化规划、统一感知-预测-规划架构、基于世界模型的规划器以及视觉-语言-动作系统。我们认为，现代端到端驾驶的关键区别不在于是否使用了中间表征，而在于这些表征是否经过学习、监督和评估，以支持安全、可行且符合路线要求的规划。为了整理相关文献，我们从输入表征、规划输出、监督信号和评估协议四个维度对现有方法进行了归纳。我们进一步审视了基准测试从开环轨迹匹配向闭环仿真、非反应式真实日志评估、长尾测试以及基于人类偏好的指标的转变。我们的分析强调，若脱离与基准一致的评估，架构的进步将难以解读，且单纯基于位移的开环指标对于证明安全和符合人类行为的驾驶证据有限。最后，我们总结了在不确定性感知规划、学习者与专家不匹配、运行时安全保障、语言-动作映射、世界模型验证以及可复现基准测试方面所面临的挑战。</td>
      <td style="width: 20%; vertical-align: top;">该论文系统回顾了端到端自动驾驶从简单控制模型向规划导向架构的演进，总结了现有方法的关键分类维度并分析了评估基准的转变。文章指出，未来研究需聚焦于闭环评估与更安全的规划方案，以解决当前领域在真实驾驶场景及基准测试中所面临的挑战。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>14. BrainWAM: Action-Space Coordination of Semantic Priors and Predictive Dynamics for Autonomous Driving</strong><br><span>Bing Zhan, Shuyao Shang, Jiahao Gu, Shuo Lu, Yuan Xu, Zhao Wang, Yida Wang, Xueyang Zhang, Kun Zhan, Lue Fan, Zhaoxiang Zhang</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-08-13</div><div>2026-08-13</div><div><a href="http://arxiv.org/abs/2608.12854v1">2608.12854v1</a> / <a href="https://arxiv.org/pdf/2608.12854v1">PDF</a></div><div>cs.RO, cs.AI, cs.CV</div></td>
      <td style="width: 10%; vertical-align: top;">VLM</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>自动驾驶需要在语义约束和预测动力学下进行规划。然而，现有的端到端驾驶方法通常只强调这一需求的一个方面：视觉-语言-动作（VLA）模型利用 VLM 先验进行语义推理，而世界动作模型（WAM）通过生成式世界建模提供具备未来感知能力的预测。这自然激发了能够同时利用语义先验和预测动力学的统一规划器的需求。然而，我们发现通过联合标记级注意力进行的简单组合会遭遇注意力分配不匹配的问题，即语义捷径会主导共享注意力空间并抑制预测动力学。受神经科学中复杂行为源于功能专门化系统间协调的证据启发，我们提出了 BrainWAM，这是一种结构化的动作空间协调框架，它将语义推理和预测性世界建模转化为两条专门的动作导向路径，并在紧凑动作表示层面将它们对齐。我们进一步引入了一种异步修正流推理策略，通过视频与动作去噪解耦，在缩短推理延迟的同时保留了与规划相关的预测上下文。BrainWAM 在 NAVSIM v1（89.5 PDMS）和 NAVSIM v2（89.6 EPDMS）上均达到了最先进的性能，始终优于仅使用 VLA 或 WAM 的方法，凸显了 BrainWAM 作为自动驾驶系统一种实用且有前景的方向。</td>
      <td style="width: 20%; vertical-align: top;">针对自动驾驶中语义推理与预测动力学难以有效结合的问题，本文提出了 BrainWAM 框架，通过在动作空间协调两个专门的路径并配合异步修正流推理策略，实现了两者的有机融合。该方法在 NAVSIM 基准测试中优于现有的单一范式方法，展示了在自动驾驶规划任务中的优越性能。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>15. FactorDrive: Adaptive Multi-Step Reasoning Driven by Planning-Critical Factors for End-to-End Autonomous Driving</strong><br><span>Guolei Huang, Tengfei She, Yuxuan Lu, Yao Huang, Yuqi Ye, Yongjun Shen</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-08-10</div><div>2026-08-10</div><div><a href="http://arxiv.org/abs/2608.09591v1">2608.09591v1</a> / <a href="https://arxiv.org/pdf/2608.09591v1">PDF</a></div><div>cs.RO, cs.CV</div></td>
      <td style="width: 10%; vertical-align: top;">VLM</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>视觉-语言模型（VLMs）提升了场景理解能力，并实现了端到端自动驾驶中的显式推理。然而，现有方法在将空间-物理证据整合到规划推理方面尚显不足，推理适应性仍然较为粗糙，无法满足特定场景的规划需求。此外，在自动驾驶后训练中，针对规划质量的推理路径优化研究尚属空白。为了解决这些局限性，我们提出了 FactorDrive，这是一个由规划关键因素（PCFs）驱动的自适应多步推理端到端自动驾驶框架。我们首先执行大规模驾驶领域指令微调以建立基础驾驶知识。在此基础上，我们构建了 PCF-CoT，这是一个将规划推理建立在轨迹相关空间-物理证据之上的思维链（CoT）数据集，并围绕场景特定的 PCF 组织推理，使推理路径的构成和深度能够适应不同的规划需求。我们进一步引入了质量搜索引导的组相对策略优化（QS-GRPO），它利用轨迹级规划奖励引导蒙特卡洛树搜索（MCTS）以发现更高规划质量的推理路径，并利用产生的响应通过 GRPO 优化策略，从而提升轨迹规划性能。在开环（nuScenes）和闭环导向（NAVSIM）基准测试上的广泛实验表明，FactorDrive 实现了最先进的规划性能。</td>
      <td style="width: 20%; vertical-align: top;">该研究针对现有自动驾驶模型推理能力不足和规划需求适配性差的问题，提出了 FactorDrive 框架。该方法通过引入规划关键因素驱动的思维链数据集，以及结合质量搜索引导的组相对策略优化，有效提升了自动驾驶系统的推理深度与轨迹规划性能。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>16. DH-VLM: Dual-Horizon Cooperative Latent Reasoning for Autonomous Driving</strong><br><span>Ziyi Song, Chen Xia, Hang Yu, Sheng Zhou, Zhisheng Niu</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-08-10</div><div>2026-08-10</div><div><a href="http://arxiv.org/abs/2608.09333v1">2608.09333v1</a> / <a href="https://arxiv.org/pdf/2608.09333v1">PDF</a></div><div>cs.RO</div></td>
      <td style="width: 10%; vertical-align: top;">VLM</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>面向自动驾驶的大规模语言模型能够增强全局理解和长程规划能力。然而，当部署在独立车辆上时，有限的传感范围和遮挡问题限制了决策的可靠性，且巨大的计算和延迟开销使得车载部署变得不切实际。协作驾驶通过利用外部代理进行信息交换提供了潜在的解决方案，但现有方法在实际约束下的语义推理能力仍然有限。为了应对这些挑战，我们提出了DH-VLM，这是一个双视野协作潜在推理框架，实现了基础设施与自车之间的非对称语义协作。基础设施聚合多层隐藏状态以形成全局推理视野的潜在引导，并通过“基础设施驱动的潜在演化”机制集成到自车模型中，用于条件化潜在优化。这使得自车能够在保持局部规划视野内自动决策的同时，利用长程的上下文理解能力。此外，我们构建了一个面向协作的问答（QA）数据集，涵盖了基础场景理解和自车个性化理解，以支持反事实和安全感知推理。广泛的实验表明，DH-VLM实现了最先进的规划性能，在L2误差上比现有最佳方法提升了14.6%，碰撞率降低了26.9%。与基于查询的端到端协作驾驶方法相比，我们的方法在通信成本上降低了57.3%，GPU内存使用率降低了25.5%，同时保持了对基础设施引导误差的强鲁棒性，为协作式自动驾驶提供了一种实用且稳健的范式。</td>
      <td style="width: 20%; vertical-align: top;">针对自动驾驶中单车感知局限与协作通信开销大的问题，该论文提出了DH-VLM双视野协作潜在推理框架。该方法通过基础设施向自车提供全局潜变量引导，实现了兼顾局部决策与全局长程上下文理解的非对称协作。实验证明，该方案在提升驾驶性能的同时显著降低了计算与通信成本。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>17. Lingjing: A Simulation Testbed for Multi-Agent Embodied Tasks in Open-Ended Cities</strong><br><span>Xiaohe Li, Yiru Wang, Junhao Fan, Mingyuan Liu, Jie Huang, Kaixin Zhang, Jiahao Li, Chen Qian, Zide Fan</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-08-08</div><div>2026-08-08</div><div><a href="http://arxiv.org/abs/2608.08045v1">2608.08045v1</a> / <a href="https://arxiv.org/pdf/2608.08045v1">PDF</a></div><div>cs.AI</div></td>
      <td style="width: 10%; vertical-align: top;">VLM</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>城市具身智能需要在动态城市中实现异构智能体（如无人机、地面机器人和自动驾驶车辆）之间的协调，因此仿真器为开发和评估此类协调提供了可扩展的基础。然而，现有平台将不同的具身形态隔离开来，并将它们与任务设计和评估解耦。我们提出了“灵境”（Lingjing），这是一个用于开放式城市环境中异构多智能体具身智能的仿真平台。灵境基于地理数据重建并渲染演进中的城市，同步多个物理引擎，并向智能体公开共享的物理和结构化城市状态。其类 Gym 的接口支持用户自定义 ReAct 智能体以及具有可配置星型或广播通信及资源约束的单智能体或多智能体自然语言任务。每个片段都成为可归因的回放，将智能体轨迹、通信与关系图变化、资源消耗及基于引擎的评估相关联，以进行系统性诊断。我们在共享的引擎在环协议下，对九个城市任务中的十二个视觉语言模型进行了评估。受控研究进一步探讨了通信、可扩展性、鲁棒性和失败溯源。结果揭示了在基础映射（Grounding）和长程执行方面存在的持续瓶颈。研究还显示了任务相关的协调权衡，以及增加容量带来的边际效应递减，同时更重的负载会进一步降低成功率。灵境提供了一个统一的测试平台，实现了城市多智能体具身智能中可复现的端到端评估和系统性故障诊断。</td>
      <td style="width: 20%; vertical-align: top;">该论文提出了一个名为“灵境”的仿真平台，旨在解决城市环境中异构多智能体协同工作的开发与评估难题。该系统通过整合地理数据重建、多物理引擎同步及统一的任务接口，支持对智能体进行端到端的性能评估与故障诊断。实验结果揭示了模型在长程执行与任务协调方面存在的瓶颈，为具身智能研究提供了可复现的测试基准。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>18. SimWAM: A Simple World Action Model for End-to-End Autonomous Driving</strong><br><span>Zongchuang Zhao, Xin Zhou, Tianyang Xu, Zhengyang Sun, Kaixuan Zhou, Honglin Li, Dingkang Liang, Xiang Bai</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>19. Adaptive-WAM: Quality-Guided Early-Exit Planning from Intermediate Video-Diffusion Features</strong><br><span>Sining Ang, Yuguang Yang, Yan Wang</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-08-06</div><div>2026-08-06</div><div><a href="http://arxiv.org/abs/2608.06008v1">2608.06008v1</a> / <a href="https://arxiv.org/pdf/2608.06008v1">PDF</a></div><div>cs.RO</div></td>
      <td style="width: 10%; vertical-align: top;">world model</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>大型视频扩散模型为自动驾驶提供了丰富的时空先验，但现有的世界-动作模型往往继承了迭代式未来视频生成的计算开销，而实际部署仅需自车轨迹。我们提出了一个基础问题：为了做出可靠的驾驶决策，究竟需要执行多少视频扩散模型的计算？通过对视频去噪时间步和扩散Transformer（DiT）深度进行对照研究，我们发现规划性能对测试的视频噪声水平基本不敏感，且从中间层已经可以解码出高质量的轨迹。基于此观察，我们提出了Adaptive-WAM，这是一种基于Wan2.2-5B骨干网的质量感知多出口规划器。轨迹扩散头被附加到选定的DiT块上，轻量级轨迹质量评分器在当前最佳解码轨迹满足阈值时终止推理，否则从缓存的隐藏状态继续计算直到更深层的出口。因此，部署的规划器避免了未来视频合成所需的迭代式无分类器引导去噪循环和VAE解码，并根据轨迹质量动态分配骨干网深度。在NAVSIM上，自适应单轨迹规划器实现了90.8的PDMS；固定出口变体在64个提议下达到了92.6的PDMS。它在NAVSIM v2上获得了89.9的EPDMS，在所对比的前视视频世界模型规划器中表现最佳。在无需目标域微调的情况下，Adaptive-WAM迁移到nuScenes数据集，平均L2误差为0.88米，碰撞率为0.08%。在A100上，自适应路由将PDMS从90.62提升至90.79，平均端到端规划延迟为170毫秒，分别比固定的第15块规划器（190毫秒）和全深度规划器（320毫秒）快约10%和47%。代码将开源。</td>
      <td style="width: 20%; vertical-align: top;">本文针对视频扩散模型在自动驾驶规划中计算冗余的问题，提出了一种Adaptive-WAM规划框架。通过在DiT中间层添加轨迹头并结合轻量级质量评分机制，该方法实现了动态的早期退出推理，在显著降低计算延迟的同时保持了高精度的轨迹规划能力。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>20. STAR-VLM: Spatiotemporal Grounding Vision-Language Models for Motion and Velocity Estimation via Automotive Radar Supervision</strong><br><span>Pou-Chun Kung, Aryaman Rao, Utkrisht Sahai, Hemanth Murali, Yi Liu, Rui-Yu Lin, Katherine A. Skinner</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-08-02</div><div>2026-08-02</div><div><a href="http://arxiv.org/abs/2608.01535v1">2608.01535v1</a> / <a href="https://arxiv.org/pdf/2608.01535v1">PDF</a></div><div>cs.CV, cs.RO</div></td>
      <td style="width: 10%; vertical-align: top;">VLM</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>视觉-语言模型（VLMs）正成为具身智能的关键组成部分，在自动标注和端到端自动驾驶中的应用日益广泛。然而，现有的提升 VLM 时空推理能力的方法往往依赖复杂的预处理流程、昂贵的人工标注或合成数据，这限制了可扩展性并引入了潜在的仿真到现实（sim-to-real）差距。此外，尽管这些方法改进了时空理解，但在处理动态场景的度量推理（例如在真实世界单位中估计物体运动）方面仍显不足。先前的研究探讨了利用基于激光雷达的度量深度监督来增强空间感知，但并未直接解决时间推理问题。我们提出了 STAR-VLM，这是一个通过车载雷达监督的框架，旨在增强视觉-语言模型在自动驾驶中的运动推理和速度度量估计能力。车载雷达是一种低成本且广泛部署的传感器，通过距离和多普勒测量提供互补的时空监督信息。通过在训练期间将这些测量值用作无标注的真值，STAR-VLM 提升了 VLM 的度量时空推理能力。在驾驶场景的实验表明，STAR-VLM 在运动分类和速度度量估计任务上均达到了最先进的水平，甚至优于专门为各项任务设计的特定方法。这些结果突显了车载雷达作为一种可扩展且经济高效的监督来源，能够用于构建面向真实世界自动驾驶的度量感知型时空 VLM。</td>
      <td style="width: 20%; vertical-align: top;">针对视觉-语言模型在自动驾驶中缺乏动态场景度量推理能力的问题，本文提出了 STAR-VLM 框架，利用车载雷达提供的距离和多普勒测量作为无标注监督信号。该方法有效增强了模型在运动推理和速度度量估计方面的性能，在多个基准测试中达到了领先水平，展示了一种低成本且可扩展的训练路径。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>21. PRISM: Privileged Probabilistic Latent Supervision for End-to-End Autonomous Driving Motion Planning</strong><br><span>Volodymyr Havrylov, Faris Janjoš, Andreas Look, Jürgen Mathes, Andreas Geiger</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-08-02</div><div>2026-08-02</div><div><a href="http://arxiv.org/abs/2608.01201v1">2608.01201v1</a> / <a href="https://arxiv.org/pdf/2608.01201v1">PDF</a></div><div>cs.RO, cs.CV</div></td>
      <td style="width: 10%; vertical-align: top;">VLM</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>端到端自动驾驶（E2E AD）系统将感知、预测和规划集成到一个可微分的架构中。尽管这些模型展现出巨大潜力，但其标准训练通常依赖于仅输出的监督，这可能导致日益复杂的模型隐藏层梯度较弱。近期的研究通过整合视觉语言模型（VLM）对潜在特征进行监督来解决这一问题，并取得了显著的实证进展，但其潜在的理论机制尚不明确。我们对该方法的研究发现，性能的提升并非源于先前认为的 VLM 推理能力，而是源于训练过程中在 E2E AD 模型与真实值（GT）数据之间建立的潜在联系。基于此见解，我们提出了一个概率深度监督框架，直接利用真实值数据对中间潜在表征进行正则化。通过将模型潜在变量视为可重参数化的分布，我们通过证据下界（ELBO）对架构进行了优化。在 nuScenes 数据集上的评估表明，利用未来真实轨迹路径对轨迹相关潜在变量进行监督，能持续提升规划性能。在训练数据和 E2E 架构完全相同的情况下，我们的方法相较于竞争性的向量化基线，规划 L2 误差降低了 8%，碰撞率降低了 3%，且计算开销可忽略不计。</td>
      <td style="width: 20%; vertical-align: top;">本文针对端到端自动驾驶中隐层监督不足的问题，指出基于VLM的监督方法实则依赖于对真实值数据的潜在连接。为此，作者提出了一种基于证据下界（ELBO）的概率深度监督框架，通过利用真实轨迹数据对中间潜在表征进行正则化。实验结果表明，该方法在不增加额外计算负担的情况下，显著提升了自动驾驶系统的规划精度并降低了碰撞率。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>22. WAM-Diff2: Hierarchical AR-to-Diffusion Distillation for Highly Efficient Autonomous Driving VLA</strong><br><span>Zhihao Zhu, Hanlin Shang, Mingwang Xu, Feipeng Cai, Zhuolin He, Yaoyi Li, Jianhua Han, Hang Xu, Siyu Zhu</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-08-02</div><div>2026-08-02</div><div><a href="http://arxiv.org/abs/2608.01035v1">2608.01035v1</a> / <a href="https://arxiv.org/pdf/2608.01035v1">PDF</a></div><div>cs.RO, cs.AI, cs.CV</div></td>
      <td style="width: 10%; vertical-align: top;">distillation</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>视觉-语言-动作 (VLA) 模型已成为端到端自动驾驶的重要范式；然而，其高效部署受到序列自回归解码带来的高计算延迟和曝光偏差的严重限制。相反，虽然专门的扩散策略能够实现低延迟的并行执行，但从零开始训练它们通常会导致缺乏全面视觉-语言推理能力的狭窄单任务架构。将预训练的自回归通用模型成功转化为并行扩散模型，可以将多任务认知智能与执行效率相结合，但由于注意力模式（因果与双向）的不匹配和优化目标的分歧，这种转变提出了巨大的架构挑战。为了弥合这一差距，我们引入了 WAM-Diff2，这是一个由三阶段分层蒸馏策略驱动的多任务离散扩散 VLA 框架。通过结构化的架构转换，包括逐步的块级适配、块级蒸馏和模型级跨尺度蒸馏，WAM-Diff2 在加速推理的同时保留了基础模型的底层语义基础。在驾驶理解、感知和规划基准上的广泛评估表明，WAM-Diff2 有效地减轻了曝光偏差，并实现了与自回归基线相当的性能。关键的是，自回归到扩散的转换带来了 2.8 倍的解码加速，在结合 FlashInfer 和 CUDA Graphs 等系统级优化后，最终可实现 15.1 倍的加速。</td>
      <td style="width: 20%; vertical-align: top;">该研究针对自回归 VLA 模型在自动驾驶中存在的计算延迟和曝光偏差问题，提出了 WAM-Diff2 框架。通过创新的三阶段分层蒸馏策略，将自回归通用模型转化为并行扩散模型，在保持多任务推理能力的同时显著提升了推理速度。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>23. Latent-Centroid Steering: Single-Pass Classifier-Free Guidance for Command-Aligned Autonomous Driving</strong><br><span>Meibo Hu, Jiamian Wang, Pichao Wang, Zhiqiang Tao</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-07-31</div><div>2026-07-31</div><div><a href="http://arxiv.org/abs/2608.00237v1">2608.00237v1</a> / <a href="https://arxiv.org/pdf/2608.00237v1">PDF</a></div><div>cs.CV, cs.RO</div></td>
      <td style="width: 10%; vertical-align: top;">VLM</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>视觉语言模型（VLMs）近期成为端到端自动驾驶的一种有前景的范式，使智能体能够将多模态输入和高级导航指令直接映射为可执行轨迹。然而在实践中，这些模型表现出持续的指令遵循鸿沟：预测轨迹往往对导航指令的敏感度较低，导致在关键决策点出现错误行为。我们将此问题识别为一种条件策略崩溃，即在多模态轨迹分布下基于回归的训练，促使模型依赖占主导地位的视觉先验，同时边缘化了语言条件的信号。为了解决这一问题，我们为基于回归的视觉语言驾驶引入了一种原则性的分类器自由引导（CFG）公式。我们展示了 CFG 可以被解释为通过对比条件预测和无条件预测，在动作空间中分离由指令诱导的残差，从而在推理时明确放大导航指令的影响。然而，标准的双向 CFG 引入了对于实时控制而言过高的延迟，并产生了嘈杂的实例级引导方向。基于对 CFG 的均值漂移解释，我们提出了潜在质心引导（LCS），这是一种单向引导机制，用类级潜在位移取代了实例级残差。通过将条件表示投影到预计算的特定指令质心，LCS 基于聚类几何执行类级潜在引导，这种方法既更稳定又具有计算效率。我们证明，LCS 在闭环（Bench2Drive）和开环（nuScenes）基准测试中，在将推理延迟降低约 50% 的同时，实现了更强的指令遵循能力和改进的驾驶性能。代码将开源。</td>
      <td style="width: 20%; vertical-align: top;">针对视觉语言驾驶模型中常见的导航指令遵循不足问题，本文分析其为条件策略崩溃，并引入了潜在质心引导（LCS）机制。该方法通过将条件表示投影至预计算的类级指令质心，在实现单向推理的同时显著提升了计算效率与导航指令的执行准确度。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>24. Outcome-Guided Distillation: A Teacher-Student Framework to Advance VLM Reasoning in Autonomous Driving</strong><br><span>Zeyu Dong, Yimin Zhu, Yu Wu, Yu Sun</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-07-31</div><div>2026-07-31</div><div><a href="http://arxiv.org/abs/2607.29052v1">2607.29052v1</a> / <a href="https://arxiv.org/pdf/2607.29052v1">PDF</a></div><div>cs.RO</div></td>
      <td style="width: 10%; vertical-align: top;">VLM, distillation</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>端到端（E2E）自动驾驶旨在学习从视觉观测到控制动作的直接映射。然而，这些E2E模型通常充当黑盒，且难以处理复杂场景。为了解决这个问题，近期研究引入视觉语言模型（VLMs）以提供显式推理，从而增强可解释性和驾驶鲁棒性。这些方法通常依赖于预生成的标注，但这些标注可能存在缺陷且耗费大量人力。本文提出了一种新框架，通过教师-学生架构整合结构化推理与几何精度。教师模型引入反思性推理，即由VLM生成逻辑解释，并在真实动作的监督下反思性地优化推理，从而在无需中间标签的情况下增强零样本泛化能力。学生模型通过监督微调提取教师的推理能力。此外，我们设计了一个独立的路径点解码器，将文本推理转化为连续轨迹。我们提出的解决方案整合了两个目标：为可解释性提供显式推理，以及提供稳健且准确的驾驶性能。该框架利用分阶段推理引擎中这两个目标之间的协同作用来增强驾驶性能，并明确使用推理来指导驾驶预测。在Waymo基准测试上的评估表明，我们的框架在零样本推理、路径点准确性和推理效率方面优于经典的推理基线方法。实验验证了该设计，证明推理文本对驾驶推理有显著贡献，与不具备推理能力的同类模型相比，性能提升约24%。我们的工作推动了基于推理的自动驾驶向可解释和可部署系统迈进。</td>
      <td style="width: 20%; vertical-align: top;">针对端到端自动驾驶模型缺乏可解释性及对标注数据依赖的问题，该论文提出了一种基于教师-学生架构的“结果引导蒸馏”框架。该方法通过教师模型的反思性推理指导学生模型，并结合路径点解码器实现从文本推理到控制轨迹的转化。实验表明，该方法在保持高推理效率的同时，有效提升了自动驾驶的可解释性与执行精度。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>25. Auto-JEPA: A Latent World Model of Continuous Intent for End-to-End Autonomous Driving</strong><br><span>Jiwei Yang, Zhengxian Chen, Chaosheng Huang, Jun Li</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-07-31</div><div>2026-07-31</div><div><a href="http://arxiv.org/abs/2607.29031v1">2607.29031v1</a> / <a href="https://arxiv.org/pdf/2607.29031v1">PDF</a></div><div>cs.RO, cs.AI</div></td>
      <td style="width: 10%; vertical-align: top;">world model</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>现有的自动驾驶世界模型通常会对未来视频、占用状态、鸟瞰图（BEV）表示或智能体运动进行密集预测。我们认为，规划无需重构完整的未来世界，只需关注影响未来自动驾驶车辆行为的场景特征。基于这一观点，我们提出了 Auto-JEPA，这是一个面向行为的潜在世界模型，通过联合嵌入预测学习连续的未来驾驶意图。给定视觉观测、自运动历史和导航指令，Auto-JEPA 可以预测出一个与未来自车轨迹的潜在表示对齐的意图嵌入。预测出的意图从固定的轨迹库中检索可执行轨迹，然后由一个场景条件下的候选选择模块进行排序。Auto-JEPA 保持视觉编码器冻结，不需要明确的感知标注，也不使用学习型的轨迹生成器。通过仅优化用于轨迹表示、意图预测和候选选择的任务特定模块，Auto-JEPA 在 NAVSIM v1 上取得了 91.3 PDMS，在 NAVSIM v2 上取得了 89.1 EPDMS。语义遮挡实验表明，遮挡动态智能体区域引起的意图变化平均是等面积随机遮挡的 2.97 倍。此外，遮挡影响未来驾驶的车辆会显著改变预测的意图和选定的轨迹，而遮挡非影响车辆时两者基本保持不变。这些结果表明，未来意图预测促使模型关注与规划相关的视觉特征，并在无需密集未来世界建模的情况下支持高质量的规划。</td>
      <td style="width: 20%; vertical-align: top;">针对自动驾驶规划中无需完整重构未来世界的问题，本文提出了 Auto-JEPA 模型，通过联合嵌入预测学习直接关联驾驶行为的潜在意图。该方法通过从预存轨迹中检索和选择最优路径，在无需密集感知标注的情况下，实现了高效且具备可解释性的自动驾驶规划。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>26. HyWorldVLA: A Vision-Language-Action Model with Hybrid World Modeling for Autonomous Driving</strong><br><span>Quanfu Yu, Xian Wu, Hao Xu, Liulong Ma</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-07-23</div><div>2026-07-23</div><div><a href="http://arxiv.org/abs/2607.20988v1">2607.20988v1</a> / <a href="https://arxiv.org/pdf/2607.20988v1">PDF</a></div><div>cs.CV, cs.AI</div></td>
      <td style="width: 10%; vertical-align: top;">world model</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>融合世界模型的视觉-语言-动作 (VLA) 模型是实现端到端自动驾驶的一种有前景的范式。尽管像素级的未来预测能够实现精细的时空推理，但在复杂的驾驶场景中会降低鲁棒性。相反，基于潜空间的世界模型虽然缓解了这种敏感性，但由于缺乏像素级的接地（grounding），往往导致可解释性受限和表征退化。为了调和这一权衡，我们提出了 HyWorldVLA，这是一个统一了像素级监督和潜空间表征学习的混合式世界-VLA 框架。在预训练阶段，HyWorldVLA 既预测由预训练视频 VAE 编码的视频潜变量，又同时重构视频帧以提供精确的像素级接地。在随后的协同微调阶段，模型仅预测潜特征，并将其输入到动作专家模块以生成轨迹。在 NAVSIM v1 和 v2 基准测试上的大量实验表明，HyWorldVLA 的性能显著优于基于像素和基于潜空间的世界模型基线。值得注意的是，我们首次对自动驾驶中世界模型的噪声鲁棒性进行了全面的定性和定量分析，为评估未来架构建立了新的基准。</td>
      <td style="width: 20%; vertical-align: top;">针对自动驾驶中像素级预测鲁棒性差与潜空间表征缺乏可解释性的矛盾，该论文提出了 HyWorldVLA 混合框架，通过结合像素级重构监督与潜空间学习来增强模型性能。该方法在预训练阶段引入多重约束，并在微调阶段优化轨迹生成，在 NAVSIM 基准测试中展现了优于现有基线的性能与噪声鲁棒性。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>27. PerceptDrive: Perception Prior World-Action Modeling with Adaptive Expert Routing for End-to-End Autonomous Driving</strong><br><span>Yushan Liu, Tianxiong Lv, Bohua Wang, Hangqi Fan, Chenxu Zhao, He Zheng, Xuchang Zhong, Yifan Xie, Congyang Zhao, Zhihao Liao, Leigang Luo, Yang Cai, Xiao-Ping Zhang, Wenbo Ding</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-07-22</div><div>2026-07-22</div><div><a href="http://arxiv.org/abs/2607.20175v1">2607.20175v1</a> / <a href="https://arxiv.org/pdf/2607.20175v1">PDF</a></div><div>cs.CV</div></td>
      <td style="width: 10%; vertical-align: top;">distillation</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>冻结的感知基础模型编码了丰富的几何、语义和动态知识。然而，狭窄的调节接口可能会削弱与任务相关的线索，而静态融合无法针对每个场景调整专家贡献。我们将此挑战表述为先验到规划的迁移问题，并引入了 PerceptDrive，这是一个具有自适应专家路由的感知先验世界-动作建模框架。PerceptDrive 将来自冻结的、驾驶适应性提供者的教师蒸馏先验和来自冻结的自监督视频编码器的密集观测潜变量馈送到可训练的专家路由世界-动作模型中。专家特定的查询分支处理这些信号，而先验保留目标将每个分支锚定到其先验上。路由器从共享场景表示中预测软门控，并在轨迹生成之前组合专家条件。在训练过程中，用于分支特定轨迹草案的特权规则子度量估计提供了软门控蒸馏目标。预测的无动作未来潜变量调节流匹配动作生成器。在推理时，特权组件不存在；仅使用一个前置摄像头，PerceptDrive 在每个规划步骤生成一条轨迹，无需测试时评分、重排序或搜索。实验表明，PerceptDrive 在 NAVSIM v1 上达到 90.4 PDMS，在 NAVSIM v2 上达到 90.2 EPDMS，性能优于现有方法。消融实验证实了先验保留和场景条件路由带来的互补收益，以及对三种先验的不同依赖性。这些结果表明，保留并自适应地路由感知先验可以在无需测试时候选选择的情况下改善直接规划。</td>
      <td style="width: 20%; vertical-align: top;">针对端到端自动驾驶中感知先验利用不足和融合僵化的问题，该论文提出了PerceptDrive框架。该方法通过引入自适应专家路由机制，将冻结的感知先验与动态场景表示相结合，无需推理时的候选搜索即可实现高效轨迹生成。实验结果证明，该模型在NAVSIM基准测试上达到了领先的性能水平。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>28. Ego-Dynamics-Augmented World Model for Autonomous Driving with Zero-Shot Cross-Chassis Adaptation</strong><br><span>Zhidong Wang, Jingsong Liang, Zirui Li, Zhan Chen, Han Yu, Chen Lv</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-07-15</div><div>2026-07-15</div><div><a href="http://arxiv.org/abs/2607.13410v1">2607.13410v1</a> / <a href="https://arxiv.org/pdf/2607.13410v1">PDF</a></div><div>cs.RO</div></td>
      <td style="width: 10%; vertical-align: top;">world model, RL</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>基于世界模型（WM）的强化学习通过在潜在空间中想象长跨度轨迹，实现了样本高效的端到端自动驾驶学习。然而，大多数驾驶世界模型运行在鸟瞰图（BEV）表示上，这种表示本质上是以自我为中心的：连续帧之间的转换将自车的运动与场景动态交织在一起。结果，世界模型花费了大量容量从扭曲的观测中恢复自我运动，从而牺牲了场景建模的保真度和想象的准确性。本文提出了 DynaDreamer，这是一种动力学增强的 Dreamer 风格强化学习方法，通过用显式的自我动力学先验来增强世界模型以解决这一问题。一个物理信息驱动的自我动力学编解码器将自我状态历史提取为紧凑且可识别的上下文，用以调节因果 Transformer 世界模型，从而对其先验和后验潜在变量进行条件化。在想象过程中，自我动力学预测器向前传播此上下文，以保持自我动力学先验与滚动过程同步。信息论分析表明，以该上下文为条件可以降低观测转换的预测熵以及先验与后验之间的 Kullback-Leibler 散度，将世界模型的建模负担限制在自我运动之外的场景动态上。该方法的另一个优势是零样本跨底盘适应：由于自我动力学上下文依赖于可识别的底盘参数，具有此前未见过的动态特性的车辆无需重新训练即可将世界模型适应到新底盘。实验表明，DynaDreamer 在城市和高速公路驾驶场景中分别将任务成功率比最强基准提高了 28% 和 61%，在推广到未知底盘时优势甚至提升至 73%。</td>
      <td style="width: 20%; vertical-align: top;">针对现有自动驾驶世界模型中自车运动与场景动态耦合导致的建模效率低下问题，本文提出了 DynaDreamer 方法。该方法通过引入物理驱动的自我动力学先验来解耦场景动态，有效降低了预测难度。实验证明该方法在复杂驾驶场景下显著提升了任务成功率，并具备出色的零样本跨底盘适应能力。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>29. BucketKD: A Safety-Aware Bucket-Based Knowledge Distillation Framework for End-to-End Motion Planning</strong><br><span>Md Nahidul Islam, Mohd Hasan Ali, Dipankar Dasgupta, Myounggyu Won</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-07-12</div><div>2026-07-12</div><div><a href="http://arxiv.org/abs/2607.10565v1">2607.10565v1</a> / <a href="https://arxiv.org/pdf/2607.10565v1">PDF</a></div><div>cs.RO, cs.LG</div></td>
      <td style="width: 10%; vertical-align: top;">distillation</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>端到端运动规划已成为自动驾驶中一种有前景的范式，通过深度神经网络将原始传感器数据直接映射为控制指令。尽管具有诸多优势，但其庞大的模型规模阻碍了在资源受限平台上的部署。在本文中，我们提出了 BucketKD，这是一种基于分桶的知识蒸馏框架，旨在生成紧凑且具有安全意识的端到端规划器。与依赖简化规划状态表示的现有先进方法相比，BucketKD 将关键的环境变量离散化为自适应桶，在保持效率的同时捕捉更丰富的场景语义。此外，我们设计了一种安全感知路径点注意力机制，通过交通研究中广泛使用的碰撞时间（TTC）公式，综合考虑障碍物邻近度和相对运动来评估每个路径点的风险水平。这使得学生模型在蒸馏过程中能更好地保留安全关键行为。在 CARLA 环境中使用 Bench2Drive 数据集进行的广泛实验表明，BucketKD 在规划准确性和安全性方面均显著优于现有的先进方法，同时保持了强大的压缩比。</td>
      <td style="width: 20%; vertical-align: top;">针对端到端自动驾驶模型规模大且安全性不足的问题，本文提出了 BucketKD 知识蒸馏框架。该方法通过基于环境变量的自适应分桶技术提升语义捕捉能力，并引入了基于碰撞时间（TTC）的安全感知路径点注意力机制。实验证明，该框架在保持高压缩比的同时，显著提升了模型在规划精度与安全性方面的表现。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>30. WCog-VLA: A Dual-Level World-Cognitive Vision-Language-Action Model for End-to-End Autonomous Driving</strong><br><span>Xuerun Yan, Zhexi Lian, Nuoheng Zhang, Shiyu Fang, Haoran Wang, Chen Lv, Jia Hu, Binyang Song</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-07-09</div><div>2026-07-09</div><div><a href="http://arxiv.org/abs/2607.08375v1">2607.08375v1</a> / <a href="https://arxiv.org/pdf/2607.08375v1">PDF</a></div><div>cs.CV, cs.AI</div></td>
      <td style="width: 10%; vertical-align: top;">world model</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>视觉-语言-动作（VLA）模型推动了端到端自动驾驶的发展。然而，现有方法要么缺乏全面的世界认知，要么受限于零碎的世界预判，本质上将这些模型局限于反应式驾驶。为了解决这一局限性，我们提出了WCog-VLA，这是一种新颖的双层世界认知VLA框架，成功地将语义世界预测与生成式世界演化相结合，从而实现了主动式自动驾驶。在语义层面，WCog-VLA通过整合3D空间感知并引入智能体Token来捕捉世界动态，同时启用博弈论思维链（Game-CoT）推理，从而统一了世界认知与推理。在生成层面，我们引入了对齐解耦扩散Transformer（ADDT）作为强大的生成式世界模型，用于合成物理上合理的联合多智能体轨迹。通过场景表示对齐，ADDT减少了所需的去噪步数，从而显著加快了推理速度。为了促进战略推理，我们进一步构建了一个包含8.5万条Game-CoT标注的大规模数据集。在NAVSIM基准测试上的广泛实验表明，WCog-VLA实现了92.9的PDMS得分，达到业界领先水平。</td>
      <td style="width: 20%; vertical-align: top;">针对现有VLA模型在端到端自动驾驶中缺乏世界认知和前瞻性决策的问题，该论文提出了WCog-VLA框架，通过整合语义层的博弈论思维链推理与生成层的对齐解耦扩散模型，实现了从反应式到主动式的自动驾驶。该研究还构建了大规模Game-CoT数据集，并在NAVSIM基准测试中证明了其在路径规划与决策任务上的优越性能。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>31. PixelPilot: Scalable Vision-Language-Action Models for End-to-End Autonomous Driving</strong><br><span>Pin Tang, Guoqing Wang, Xiangxuan Ren, Zhongdao Wang, Guodongfang Zhao,  Bailan, Chao Ma</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-07-06</div><div>2026-07-06</div><div><a href="http://arxiv.org/abs/2607.04637v1">2607.04637v1</a> / <a href="https://arxiv.org/pdf/2607.04637v1">PDF</a></div><div>cs.CV</div></td>
      <td style="width: 10%; vertical-align: top;">VLM</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>视觉-语言-动作模型（VLAs）利用视觉-语言模型（VLMs）的高级推理能力，在复杂的自动驾驶场景中展现出良好的泛化前景。现有的 VLAs 通常从 2D 图像预测和优化 3D 轨迹。尽管这种方法很直观，但其 2D 到 3D 的预测过程本质上与相机参数耦合，限制了在异构驾驶数据集上的数据可扩展性。此外，直接在 3D 空间进行优化会导致模型收敛到平凡解，使得 VLAs 依赖于自我状态而非视觉场景理解。为了解决这些问题，我们提出了 PixelPilot，这是一种具有解耦规划和提升范式的新型 VLA。在规划阶段，PixelPilot 将场景理解和轨迹预测重构为图像平面上与传感器无关的 2D 到 2D 任务，从而促进了跨不同数据集的可扩展训练。规划出的 2D 轨迹仅在推理过程中确定性地提升至 3D，确保了对视觉线索的充分利用以及跨不同车辆的泛化能力。为了实现这一范式，我们提出了一种知识灌输策略学习策略，通过组相对策略优化（GRPO）应用密集的中间奖励，以强化从视觉感知到空间规划的严格因果链。大量实验表明，PixelPilot 在开环和闭环设置中均达到了最先进的性能，验证了其卓越的可扩展性和视觉推理能力。</td>
      <td style="width: 20%; vertical-align: top;">针对现有自动驾驶 VLA 模型在 3D 轨迹预测中存在的相机参数耦合与泛化瓶颈，PixelPilot 提出了一种解耦的 2D 到 2D 规划与提升范式。该方法通过在图像平面进行规划并引入基于 GRPO 的知识灌输策略，有效增强了模型的视觉推理能力与数据可扩展性，在开环和闭环测试中均表现出显著的性能提升。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>32. RoboVista: Evaluating Vision Language Models for Diverse Robot Applications</strong><br><span>Shuangyu Xie, Kaiyuan Chen, Ziyang Chen, Simeon Adebola, Yixuan Huang, Zehan Ma, Tianshuang Qiu, Wentao Yuan, Dhruv Shah, Pannag R. Sanketi, Ken Goldberg</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-07-06</div><div>2026-07-06</div><div><a href="http://arxiv.org/abs/2607.04610v1">2607.04610v1</a> / <a href="https://arxiv.org/pdf/2607.04610v1">PDF</a></div><div>cs.RO</div></td>
      <td style="width: 10%; vertical-align: top;">VLM</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>机器人技术的多元化应用（如工业和农业）要求机器人能够在不同的机体、多变的视觉条件和复杂的规划场景下运行。视觉语言模型（VLM）为通用且可解释的机器人推理提供了一个有前景的基础。将 VLM 与多样化的机器人应用对齐，需要对机器人行为背后的个体决策组件进行模块化理解。对于主要基于遥操作端到端数据集的传统机器人基准测试而言，捕捉这种结构具有挑战性。我们提出了机器人问答（RQA）这一模块化评估框架，以及由真实机器人系统、研究论文和专家标注整理而成的基准测试 RoboVista。RoboVista 包含 474 个带有专家推理标注的视觉问答（VQA）实例，涵盖了农业、工业、家庭、手术机器人、自动驾驶和开放机器人数据集中的 39 种独特任务类型。在 RoboVista 上的实验表明，最先进的 VLM 仍存在显著差距。物理机器人实验结果显示，RoboVista 的性能表现与现实世界任务的执行效果之间存在强相关性。</td>
      <td style="width: 20%; vertical-align: top;">针对机器人领域缺乏模块化评估标准的问题，本文提出了 RoboVista 基准测试框架，通过 474 个真实世界的视觉问答实例来评估视觉语言模型的推理能力。该研究揭示了现有模型在机器人应用中的表现差距，并证明了该基准测试结果与现实环境下的机器人任务执行成功率具有强相关性。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>33. CritiqueDriveVLM: From Verifier-Guided Reinforcement Learning to Latent Thought Distillation for Autonomous Driving</strong><br><span>Zhaohong Liu, Hao Ye, Xianlin Zhang, Mengshi Qi</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-07-05</div><div>2026-07-05</div><div><a href="http://arxiv.org/abs/2607.04179v1">2607.04179v1</a> / <a href="https://arxiv.org/pdf/2607.04179v1">PDF</a></div><div>cs.CV, cs.AI</div></td>
      <td style="width: 10%; vertical-align: top;">VLM, distillation, RL</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>端到端视觉语言模型（VLM）在自动驾驶领域展现出巨大潜力。然而，标准的监督微调（SFT）往往存在推理幻觉和保守偏差问题。尽管传统的工具增强框架和思维链（CoT）方法能够缓解这些问题，但它们会导致过高的 token 消耗和无法接受的延迟，使得实时部署变得不切实际。为了解决这种可靠性与效率之间的权衡，我们提出了 CritiqueDriveVLM，这是一个新型的三阶段统一框架，将推理过程直接内化到 VLM 中。首先，我们引入了由多维验证器引导的批判驱动多轮强化学习（RL）。通过提供细粒度的标量反馈和多轮惩罚，我们迫使策略内化逻辑推导，从而培养出一个无需脆弱外部工具即可实现高精度的鲁棒“系统2”教师模型。随后，我们提出了潜在思维蒸馏法来克服延迟瓶颈。通过将学生模型的潜在表征与教师模型完全收敛的推理状态对齐，我们将深层的逻辑能力压缩为一个快速且无需 CoT 的“系统1”学生模型。在广泛使用的 DriveLMM-01 基准测试上的大量实验表明，该方法取得了显著改进。与基础模型相比，我们的无工具教师模型将多项选择题（MCQ）准确率从 55.54% 提升至 76.54% 的行业领先水平。更关键的是，我们蒸馏出的学生模型在保持竞争力的推理深度的同时，将生成长度大幅缩减至平均仅 28 个 token。这使推理延迟降低了 88%（从 3482 毫秒降至 416 毫秒），为低延迟自动驾驶铺平了一条高度稳健的道路。</td>
      <td style="width: 20%; vertical-align: top;">针对自动驾驶中端到端 VLM 推理效率低和可靠性不足的问题，本文提出了 CritiqueDriveVLM 框架。通过基于多维验证器的强化学习构建高性能教师模型，并利用潜在思维蒸馏技术训练出快速、无须思维链的学生模型。实验表明，该方法在大幅降低推理延迟的同时，显著提升了模型的逻辑推理精度。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>34. CLEAR: Closed-Loop Reinforcement Learning at Scale for End-to-End Autonomous Driving</strong><br><span>Yunxiao Shi, Hong Cai, Mohammad Ghavamzadeh, Fatih Porikli</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-07-03</div><div>2026-07-03</div><div><a href="http://arxiv.org/abs/2607.02841v1">2607.02841v1</a> / <a href="https://arxiv.org/pdf/2607.02841v1">PDF</a></div><div>cs.RO, cs.CV</div></td>
      <td style="width: 10%; vertical-align: top;">RL</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>端到端自动驾驶（E2E-AD）旨在将原始传感器信息直接映射为驾驶动作。近期，随着多模态大语言模型（MLLM）的快速发展，研究人员提出了用于 E2E-AD 的视觉-语言-动作（VLA）模型范式，旨在将视觉感知、语言理解和动作预测整合到一个策略中。然而，现有的基于 VLA 的策略主要采用模仿学习，仅通过优化记录的专家轨迹的距离指标来学习驾驶。这种开环训练与闭环推理之间的分布偏移导致了闭环规划中的性能不佳。为了缩小这一差距，我们提出了 CLEAR，这是一个支持在大规模端到端自动驾驶中利用强化学习（RL）进行闭环训练的系统。我们提出围绕预训练 VLA 策略中的航点先验学习一种新型残差航点策略，从而有效利用其中蕴含的知识。此外，扩展基于视觉策略的强化学习的主要挑战之一是并行仿真环境的数量，因为强化学习对数据需求巨大。为此，我们设计了一个异构流水线，将仿真器和 VLA 学习器置于不同的计算组中，这使我们能够在避免资源竞争并保持训练稳定性的同时，大幅增加并行运行的仿真环境数量。研究表明，仅使用简单的奖励函数，CLEAR 就能显著优于先前的方法，并在具有挑战性的 CARLA longest6 v2 和 Bench2Drive 基准测试中达到了新的最优性能。</td>
      <td style="width: 20%; vertical-align: top;">针对端到端自动驾驶中模仿学习存在的开环训练与闭环推理分布偏移问题，本论文提出了名为 CLEAR 的强化学习闭环训练系统。该系统通过引入残差航点策略有效利用预训练模型知识，并设计异构流水线提升了大规模并行仿真效率。实验结果表明，该方法在 CARLA 等主流基准测试中显著提升了自动驾驶的闭环规划性能。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>35. Teaching Vision-Language-Action Models What to See and Where to Look</strong><br><span>Yuguang Yang, Canyu Chen, Zhewen Tan, Yizhi Wang, Zichao Feng, Chunyang Liu, Kehua Sheng, Juan Zhang, Linlin Yang, Baochang Zhang, Yan Wang, Bo Zhang, Xianbin Cao</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-07-02</div><div>2026-07-02</div><div><a href="http://arxiv.org/abs/2607.01658v1">2607.01658v1</a> / <a href="https://arxiv.org/pdf/2607.01658v1">PDF</a></div><div>cs.CV</div></td>
      <td style="width: 10%; vertical-align: top;">distillation</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>视觉-语言-动作（VLA）模型已成为端到端自动驾驶的一种有前景的范式。然而，现有 VLA 的训练过于依赖以文本为中心的视觉问答和思维链推理数据，这强调了语言推理而非动作导向的规划。因此，所学习的表征虽然捕捉到了语义知识，但缺乏对可靠轨迹预测至关重要的空间依赖性。我们提出了 DriveTeach-VLA 框架，明确地教导 VLA 看到什么以及看向哪里。驾驶感知视觉蒸馏（DVD）将驾驶特定的感知先验注入视觉编码器，而二维轨迹引导提示（2D-TGP）则提供了与可行驾驶轨迹对齐的空间条件。它们共同构成了一个视觉引导的学习流水线：看到什么（DVD 预训练）- 看向哪里（TGP 引导的监督微调）- 如何行动（TGP 引导的组相对策略优化）。DriveTeach-VLA 在 NAVSIM 和 nuScenes 数据集上达到了最先进的性能。代码已开源。</td>
      <td style="width: 20%; vertical-align: top;">针对现有 VLA 模型在自动驾驶任务中缺乏空间依赖性和动作规划能力的问题，本文提出了 DriveTeach-VLA 框架。该方法通过驾驶感知视觉蒸馏和轨迹引导提示，显式地向模型注入感知先验并提供空间条件。实验表明，该方法在 NAVSIM 和 nuScenes 基准测试中实现了性能提升。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>36. OWMDrive: Causality-Aware End-to-End Autonomous Driving via 4D Occupancy World Model</strong><br><span>Junjie Cheng, Ruiqi Song, Ye Wu, Nanxing Zeng, Ximiao Li, Yunfeng Ai</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-06-29</div><div>2026-06-29</div><div><a href="http://arxiv.org/abs/2606.30421v1">2606.30421v1</a> / <a href="https://arxiv.org/pdf/2606.30421v1">PDF</a></div><div>cs.CV</div></td>
      <td style="width: 10%; vertical-align: top;">world model</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>自动驾驶系统正稳步向端到端范式转变，以减轻基于规则的流程在复杂交通环境中适应性不足的问题。然而，大多数现有的学习方法仍基于当前场景的静态表示进行决策，缺乏对交通交互中未来演变过程的明确预测或时间因果动态建模。这种局限性常导致在遮挡和突发事件等高不确定性条件下，规划结果不稳定或过于保守。为了克服这些挑战，我们引入了OWMDrive，这是一个基于4D占用世界模型的生成式端到端驾驶框架，用于多步3D占用预测，作为引导基于扩散规划的条件先验。规划器在当前观测和预测未来状态的约束下，迭代细化候选轨迹以生成增强的驾驶轨迹。通过对未来视界的场景演变进行显式建模，OWMDrive捕捉了关键的时空因果依赖关系，从而实现了更具前瞻性和鲁棒性的轨迹生成。大量实验表明，OWMDrive显著提高了规划的可靠性和安全性，特别是在具有挑战性和部分可观测的驾驶场景中。</td>
      <td style="width: 20%; vertical-align: top;">针对现有端到端自动驾驶模型缺乏时空因果建模导致决策不稳定的问题，本文提出了OWMDrive框架。该方法通过构建4D占用世界模型预测未来场景演变，并将其作为先验信息引导扩散模型进行轨迹规划。实验证明，该方法在复杂及遮挡场景下显著提升了驾驶轨迹的安全性与鲁棒性。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>37. LWDrive: Layer-Wise World-Model-Guided Vision-Language Model Planning for Autonomous Driving</strong><br><span>Chen Yang, Yuhao Wei, Ze Xu, Ziheng Zou, Shuang Liang, Delin Ouyang, Lingfeng Qi, Jie Li, Guofa Li</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>38. PlanRL: A Trajectory Planning Architecture for Reinforcement Learning-based Driving Experts</strong><br><span>Joonhee Lim, Yongjae Lee, Jangho Shin, Dongsuk Kum</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-06-25</div><div>2026-06-25</div><div><a href="http://arxiv.org/abs/2606.26858v1">2606.26858v1</a> / <a href="https://arxiv.org/pdf/2606.26858v1">PDF</a></div><div>cs.RO</div></td>
      <td style="width: 10%; vertical-align: top;">RL</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>强化学习（RL）已成为开发自动驾驶专家系统的主要框架。然而，大多数现有的基于强化学习的专家系统旨在输出直接控制指令（如油门、转向），这些方法存在可解释性差、学习道路几何结构的空间复杂度高以及与现代端到端规划架构兼容性差等问题。为了解决这些局限性，我们提出了一种新的用于强化学习驾驶专家的轨迹规划架构，该架构将强化学习策略与基于多项式的轨迹规划器相结合。通过采用Frenet坐标系，我们的方法将复杂的道路几何结构简化为曲线框架，提供了一个有助于策略学习的结构化坐标先验。此外，我们将运动学可行性检查纳入规划阶段，以确保生成的轨迹保持在车辆的物理限制内，从而有效缓解了规划系统中常见的累积跟踪误差。我们在关键的CARLA基准测试中评估了我们的方法，结果显示其性能显著优于现有的基于控制的强化学习专家系统。在CARLA离线排行榜v1和NoCrash基准测试中，我们的方法分别将驾驶得分提高了5%和11%，并将成功率分别提高了8%和19%。</td>
      <td style="width: 20%; vertical-align: top;">针对现有基于强化学习的自动驾驶方案在可解释性和兼容性上的不足，本文提出了一种集成强化学习策略与轨迹规划器的PlanRL架构。该方法利用Frenet坐标系简化几何表征，并通过运动学可行性检查保障轨迹质量。实验结果表明，该方案在多个CARLA基准测试中的性能优于现有的控制型强化学习专家系统。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>39. ASSCG: Just-Right Gating over Chattering for Fast-Slow LLM Planning in Autonomous Driving</strong><br><span>Sining Ang, Yuan Chen, Liu Haiyan, Xuanyao Mao, Jason Bao,  Xuliang, Bingchuan Sun, Yan Wang</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-06-24</div><div>2026-06-24</div><div><a href="http://arxiv.org/abs/2606.25509v1">2606.25509v1</a> / <a href="https://arxiv.org/pdf/2606.25509v1">PDF</a></div><div>cs.RO, cs.CV</div></td>
      <td style="width: 10%; vertical-align: top;">VLM, RL</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>大语言模型（LLM）能够改善自动驾驶规划，但在线查询成本高昂；现有的快慢规划器往往依赖人工设计的触发规则，导致慢速系统调用过度或时机不当。我们将慢速系统调用建模为一个资源感知的序列决策问题，并提出了自适应慢速系统控制门（ASSCG），它能在帧级别做出查询/缓存/丢弃的决策，以决定刷新、重用或抑制慢速指导。ASSCG 使用 RWKV 主干网络进行高效的长程门控，并经过监督微调及后续的 GRPO 风格计算感知强化微调训练。我们将 ASSCG 应用于两种快慢架构：(i) 在 nuPlan Hard20 闭环评估中，ASSCG 将 AsyncDriver 的得分提升至 67.28（+2.28），同时将端到端平均推理延迟降低了 60%；(ii) 在基于 RecogDrive 的双系统评估中，我们将原始 VLM-2B 模块替换为轻量级 ViT 快速规划器并添加 LLM 慢速规划器，在 NAVSIM 上取得了 91.4 的 PDMS（+0.6）并将平均速度提升了 25%。项目页面（含视频可视化和额外结果）见 https://williamxuanyu.github.io/asscg/。</td>
      <td style="width: 20%; vertical-align: top;">针对自动驾驶中大模型规划成本高且触发机制僵化的问题，本文提出了 ASSCG 框架，将慢速系统的调用建模为资源感知决策问题。通过使用基于 RWKV 的门控机制并结合强化学习训练，该方法在保持自动驾驶规划性能的同时，显著降低了计算延迟并提升了推理效率。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>40. Lagrange: An Open-Vocabulary, Energy-Based Sparse Framework for Generalized End-to-End Driving</strong><br><span>Shihao Ji, HongXi Li, Zihui Song, Mingyu Li</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-06-18</div><div>2026-06-18</div><div><a href="http://arxiv.org/abs/2606.20274v1">2606.20274v1</a> / <a href="https://arxiv.org/pdf/2606.20274v1">PDF</a></div><div>cs.AI</div></td>
      <td style="width: 10%; vertical-align: top;">VLM</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>将端到端自动驾驶扩展到复杂的开放世界环境，需要感知模型能够推广到异常场景，并需要规划器生成运动学上有效的轨迹。现有的范式在表征效率和泛化能力之间面临明显的二分法。稠密模型（如占用网络）虽然在几何上很鲁棒，但会导致关键的计算瓶颈，并且难以进行高级语义推理。相反，稀疏的、基于查询的规划器虽然高效，但依赖于封闭集的定义，这使其容易受到分布外（OOD）事件的影响。尽管最近的视觉-语言-动作（VLA）模型提供了开放词汇的推理能力，但它们的自回归、离散令牌生成方式与车辆动力学对连续、高频控制的要求存在根本冲突。为了解决这个问题，我们提出了 Lagrange，一个基于掩码潜在场（MLF）的开放词汇、计算稀疏的驾驶框架。Lagrange 不依赖稠密的体积重建或封闭集查询机制，而是利用视觉-语言模型（VLM）将与类别无关的对象提议编码为连续的语义视觉令牌。我们引入了一个意图驱动的掩码交叉注意力模块，用于在时间上过滤不相关的实体，将注意力令牌解码为定义在空间坐标上的隐式连续能量场。通过将决策问题框定为跨越该能量场的拉格朗日作用量最小化问题，我们在执行避障的同时强制执行对车辆运动学的严格遵从。在标准（nuScenes）和长尾（CODA）基准测试上的广泛离线评估表明，Lagrange 为稳健、可解释且运动学上可行的开放世界自动驾驶建立了一个有前景的框架。</td>
      <td style="width: 20%; vertical-align: top;">针对端到端自动驾驶在计算效率与泛化能力间的平衡难题，本文提出了基于掩码潜在场（MLF）的 Lagrange 框架。该方法利用视觉-语言模型处理开放词汇语义，并通过拉格朗日作用量最小化将决策过程转化为连续能量场优化。实验表明，该方法在保持计算稀疏性的同时，有效提升了复杂场景下自动驾驶的运动学可行性与稳健性。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>41. Scaling Self-Play for End-to-End Driving</strong><br><span>Luke Rowe, Roger Girgis, Rodrigue de Schaetzen, Daphne Cornelisse, Alaap Grandhi, Felix Heide, Eugene Vinitsky, Christopher Pal, Liam Paull</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>42. Formal Verification of Learned Multi-Agent Communication Policies via Decision Tree Distillation</strong><br><span>Ahmad Farooq, Kamran Iqbal</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-06-17</div><div>2026-06-17</div><div><a href="http://arxiv.org/abs/2606.19632v1">2606.19632v1</a> / <a href="https://arxiv.org/pdf/2606.19632v1">PDF</a></div><div>cs.RO, cs.AI, cs.LG, cs.LO, cs.MA</div></td>
      <td style="width: 10%; vertical-align: top;">distillation, RL</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>多智能体强化学习（MARL）使智能体能够通过涌现通信发展协作策略，但神经策略缺乏无人机群和自动驾驶车队等安全关键型机器人部署所需的正式安全保障。我们提出了首个通过策略抽象对学习到的多智能体通信策略进行安全验证的端到端框架：将神经策略蒸馏为可解释的决策树，随后进行形式化验证，实证分析确认了验证后的安全属性可以迁移回原始网络。我们的四阶段流程包括从智能体观测中提取领域特定特征、实现与神经策略保真度达 97.9% +/- 1.2% 的决策树蒸馏、自动翻译为具有完整特征到状态变量对应关系的 PRISM 概率模型检查器规范，以及通过成对分解、联合边界聚合和经验邻居建模进行的概率计算树逻辑（PCTL）属性组合验证。在评估 5-7 个智能体协作的矢量量化变分信息瓶颈（VQ-VIB）策略时，我们验证了 18 个涉及安全、活性和协作的时序逻辑属性，属性满足度达到 88.9%，并满足所有五个安全阈值（碰撞概率为 0.3%，阈值为 1%）。对原始神经策略的蒙特卡洛验证证实，验证后的安全属性迁移偏差小于等于 0.6 个百分点（95% 置信区间）。离散 VQ-VIB 消息相较于连续方法在保真度上具有 11.6 到 13.6 个百分点的优势，并使验证速度提升 3-4 倍。我们的框架为蒸馏策略抽象提供了经过实证验证的安全保障，成为深度 MARL 与多机器人部署正式安全工作流之间的实用桥梁。</td>
      <td style="width: 20%; vertical-align: top;">针对多智能体强化学习策略缺乏安全保障的问题，本文提出了一种通过决策树蒸馏将神经策略转换为可解释模型并进行形式化验证的框架。该方法通过将策略抽象为决策树并结合概率模型检测，在无人机协作任务中实现了高效的属性验证。实验证明，该方法不仅能保证高保真度，还成功将安全属性迁移至原始网络，为复杂多机器人系统的安全部署提供了有效手段。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>43. TerraTransfer: Learning End-to-End Driving Policies Without Expert Demonstrations</strong><br><span>Zikang Xiong, Weixin Li, Zhouchonghao Wu, Akshay Rangesh, Saarth Bonde, Grantland Hall, Chen Tang, Yihan Hu, Wei Zhan</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-06-16</div><div>2026-06-16</div><div><a href="http://arxiv.org/abs/2606.17386v1">2606.17386v1</a> / <a href="https://arxiv.org/pdf/2606.17386v1">PDF</a></div><div>cs.CV, cs.AI, cs.RO</div></td>
      <td style="width: 10%; vertical-align: top;">RL</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>端到端自动驾驶在基准测试和实际部署中均已实现顶尖性能。然而，其标准的训练方案在各个阶段的成本均较高：收集和标注数百万帧驾驶数据耗资巨大，而基于图像的闭环强化学习又受限于照片级真实渲染及大型视觉主干网络的单步推理成本。在向量化模拟器中进行的自我博弈改变了这一经济性：每秒可完成数百万次 rollout，且状态分布自然涵盖了驾驶日志中不存在的碰撞、险情及恢复场景。我们的方法通过解耦“驾驶学习”与“感知学习”来利用这种不对称性。我们首先通过自我博弈预训练一个单一策略，然后通过动作 KL 散度及批量关系低秩结构损失，将其潜在空间与预训练的视觉主干网络对齐。动作目标源自自我博弈策略，因此对齐过程无需依赖带标注的轨迹数据。仅需成对的（图像，场景状态）数据集即可，无需模拟预训练所必需的精选专家演示数据。在基于 3D 高斯溅射的照片级真实感闭环场景中，所生成的端到端策略达到了或超过了先前的端到端方法。</td>
      <td style="width: 20%; vertical-align: top;">针对端到端自动驾驶训练对高质量专家数据依赖性强、成本高昂的问题，该论文提出一种名为 TerraTransfer 的方法。该方法通过在向量化模拟器中进行自我博弈预训练驾驶策略，并利用潜在空间对齐技术将其迁移至视觉主干网络，从而在无需专家演示的情况下实现了高效的端到端学习。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>44. DriveJudge: Rethinking Autonomous Driving Evaluation with Vision-Language Models</strong><br><span>Xinglong Sun, Kevin Xie, Jenny Schmalfuss, Despoina Paschalidou, Xiuming Zhang, Sanja Fidler, Kashyap Chitta, Jose M. Alvarez</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-06-15</div><div>2026-06-15</div><div><a href="http://arxiv.org/abs/2606.17362v1">2606.17362v1</a> / <a href="https://arxiv.org/pdf/2606.17362v1">PDF</a></div><div>cs.CV, cs.AI, cs.LG, cs.RO</div></td>
      <td style="width: 10%; vertical-align: top;">VLM</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>自动驾驶已转向端到端策略学习，由于驾驶质量高度依赖于场景，因此可靠且可解释的策略评估成为一项基础性挑战。常用的基于规则的驾驶指标（如 EPDMS）虽具可解释性但缺乏对情境的感知，而近期基于视觉语言模型（VLM）的评估方法虽然具备情境感知能力，却受限于 VLM 输出的模糊性和物理基础薄弱的问题。为了实现既具可解释性又具备情境感知的驾驶评估，我们提出了 DriveJudge。DriveJudge 是一款驾驶评估代理，它将基于规则的评估与视觉语言模型推理相结合，在解读环境背景后选择性地调用具备物理基础的确定性规则函数。为了训练和评估 DriveJudge，我们策划了一个包含 33,577 个具有挑战性的驾驶样本的大规模数据集，并附有人类对给定场景下驾驶行为是否合理的标注。基于该数据集，我们探讨了驾驶指标评估这一尚未充分研究的问题，并引入了两项符合人类价值观的基准任务：驾驶质量分类和轨迹偏好选择。实验结果显示，DriveJudge 在驾驶质量分类方面较 EPDMS 提升了 21.23 的 AUC 值，在轨迹偏好选择方面较近期基于 VLM 的 DriveCritic 提升了 6.5%，为可解释且精确的驾驶评估设定了新标准。</td>
      <td style="width: 20%; vertical-align: top;">针对现有自动驾驶评估方法在可解释性与情境感知之间的权衡难题，本文提出了 DriveJudge 评估代理，通过结合 VLM 推理与物理规则约束来实现更精准的评估。研究团队构建了一个大规模人工标注数据集，并在驾驶质量分类与轨迹偏好选择任务上验证了该方法优于现有基准的性能。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>45. HOLO-MPPI: Multi-Scenario Motion Planning via Hierarchical Policy Optimization</strong><br><span>Youngjae Min, Jovin D&#x27;sa, Faizan M. Tariq, David Isele, Navid Azizan, Sangjae Bae</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-06-15</div><div>2026-06-15</div><div><a href="http://arxiv.org/abs/2606.16480v1">2606.16480v1</a> / <a href="https://arxiv.org/pdf/2606.16480v1">PDF</a></div><div>cs.RO, cs.AI, eess.SY</div></td>
      <td style="width: 10%; vertical-align: top;">world model, RL</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>部署在现实世界中的机器人必须能够在无需针对每个场景重新调整的情况下，跨多种场景规划运动。端到端强化学习（RL）可以跨场景泛化，但在分布偏移、奖励设定错误和随机交互下往往变得脆弱。模型预测路径积分（MPPI）控制可以在无需梯度的情况下实现强大的实时优化，但其性能取决于良好的采样先验，而手动设计先验无法扩展到多场景部署。我们提出了 HOLO-MPPI（高层离线，底层在线 MPPI），这是一个将高层策略学习与底层随机最优控制相结合的多场景运动规划框架。离线时，我们学习一个高层策略，在抽象动作空间中提出稳健的场景规划，并结合学习到的世界模型进行在线演练。在线时，该策略作为数据驱动的先验生成器，根据当前观测和目标对 MPPI 的采样分布进行参数化。随后，MPPI 在此先验周围实时优化底层控制序列，以适应局部干扰。我们通过设计有效的高层动作空间和定制的模型架构，将 HOLO-MPPI 应用于自动驾驶。在各种驾驶场景中的评估表明，HOLO-MPPI 在保持实时控制的同时，超越了 MPPI 和端到端 RL 基准。</td>
      <td style="width: 20%; vertical-align: top;">针对机器人多场景运动规划中通用性与鲁棒性的挑战，本文提出了 HOLO-MPPI 框架。该方法结合了离线高层策略学习与在线 MPPI 随机最优控制，利用高层策略生成自适应采样先验，实现了对局部环境干扰的实时优化。实验证明，该框架在自动驾驶任务中显著提升了规划性能与泛化能力。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>46. GraphWorld: Long-Horizon Planning with World Models for End-to-End Autonomous Driving</strong><br><span>Ziying Song, Caiyan Jia, Lin Liu, Lei Yang, Shengkai Zhang, Feiyang Jia, Fengda Zhao, Peiliang Wu, Shaoqing Xu, Chen Lv, Yadan Luo</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-06-15</div><div>2026-06-15</div><div><a href="http://arxiv.org/abs/2606.16274v1">2606.16274v1</a> / <a href="https://arxiv.org/pdf/2606.16274v1">PDF</a></div><div>cs.CV</div></td>
      <td style="width: 10%; vertical-align: top;">world model</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>端到端自动驾驶通过在单一学习框架内统一感知、预测和规划，在短视界决策方面取得了显著进展。然而，大多数现有的端到端自动驾驶方法仍局限于短视界规划，缺乏对长期时间依赖性的建模能力，这严重限制了其在复杂且高度交互的驾驶场景中的泛化能力和安全性。在这项工作中，我们提出了 GraphWorld，这是一个通过潜在世界模型明确增强长视界规划的端到端自动驾驶框架。我们引入了以自我为中心的交互图，基于空间邻近性自适应地建模关键相邻代理，并通过跨节点交叉注意力将关系上下文传播到规划查询中。我们提出了世界状态条件规划，通过建模自车与周围代理之间的交互来学习以自我为中心的潜在世界表征。这种潜在世界状态捕捉了关键的交互动力学和与安全相关的语义，并作为条件信号来指导长视界、具有安全意识的轨迹规划。在 Bench2Drive、NAVSIMv1/2 和 nuScenes 上的大量实验表明，GraphWorld 显著降低了碰撞率并提高了长视界规划性能，验证了其在复杂驾驶环境中的有效性。</td>
      <td style="width: 20%; vertical-align: top;">针对端到端自动驾驶在长视界规划和长期交互建模上的不足，本文提出了 GraphWorld 框架。该方法通过构建以自我为中心的交互图和学习潜在世界状态，有效捕捉关键交互动态并指导安全轨迹规划。实验证明，该框架在多个基准测试中显著提升了长视界规划性能并降低了碰撞率。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>47. RT-VLA: Real-Time Vision-Language-Action Models via Knowledge Distillation</strong><br><span>Xiangyu Huang, Zhenlin Hua, Han Zhou, Shounak Sural, Ragunathan Rajkumar</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-06-12</div><div>2026-06-12</div><div><a href="http://arxiv.org/abs/2606.14010v1">2606.14010v1</a> / <a href="https://arxiv.org/pdf/2606.14010v1">PDF</a></div><div>cs.CV, cs.LG, cs.RO</div></td>
      <td style="width: 10%; vertical-align: top;">distillation</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>视觉-语言-动作（VLA）模型通过联合建模视觉感知、语言推理、可解释性和动作预测，在端到端自动驾驶方面展现出巨大潜力。然而，它们庞大的视觉-语言骨干网络和推理模块导致了严重的推理延迟，从而阻碍了其在复杂的道路网络环境中的实际部署。我们提出了 RT-VLA，这是一种轻量级的蒸馏 VLA 模型，它通过多级监督蒸馏将最先进的 SimLingo 模型的驾驶和推理能力转移到一个紧凑的学生模型中。RT-VLA 保留了基于语言的推理能力，并通过对安全关键驾驶时刻进行离线语言分析来支持事后解释，且不会增加实时控制的延迟。与 SimLingo 教师模型相比，RT-VLA 在保持具有竞争力的闭环驾驶和语言推理性能的同时，将纯视觉模式下的推理时间缩短了 44.8 倍，在视觉+语言模式下缩短了 7.9 倍。这些结果表明，监督蒸馏是构建实时、可解释的 VLA 式自动驾驶模型的实用方法。</td>
      <td style="width: 20%; vertical-align: top;">针对大型 VLA 模型在自动驾驶应用中推理延迟过高的问题，本文提出了 RT-VLA 轻量级模型。通过采用多级监督蒸馏技术，该模型成功将 SimLingo 的驾驶与推理能力转移至紧凑网络中，在显著降低推理延迟的同时，有效保证了闭环驾驶性能与可解释性。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>48. Multi-Agent Embodied Autonomous Driving: From V2X Information Exchange to Shared World Models</strong><br><span>Senkang Hu, Zhengru Fang, Yihang Tao, Zihan Fang, Sam Tak Wu Kwong, Yuguang Fang</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-06-11</div><div>2026-06-11</div><div><a href="http://arxiv.org/abs/2606.13840v1">2606.13840v1</a> / <a href="https://arxiv.org/pdf/2606.13840v1">PDF</a></div><div>cs.RO, cs.CV</div></td>
      <td style="width: 10%; vertical-align: top;">world model</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>自动驾驶正从孤立的车辆智能转向多智能体具身系统，这些系统在不确定性下共享感知、推断意图并协调行动。本综述通过共享世界模型（SWMs）的视角审视了这一转变，即车辆、基础设施和其他交通参与者之间维护的预测性跨智能体表征。我们回顾了超过380篇文献，涵盖车联网（V2X）通信、协作感知、智能体间认知、协同规划、端到端协同驾驶，以及用于闭环验证的仿真和数据引擎。核心问题是如何将交换的观测结果转化为对齐的状态、感知意图的交互以及协调的后续行动。在所调查的文献中，评估仍集中在仿真、精选基准测试和离线协议中。基于基础模型的协调在开放交通中也缺乏经过验证的实时安全保障。这些差距促成了多智能体具身自动驾驶（MAEAD）的关键研究重点：可验证的共享状态维护、稳健的意图与规划对齐，以及在通信、延迟和部署约束下的安全协调行动。</td>
      <td style="width: 20%; vertical-align: top;">该论文综述了多智能体具身自动驾驶领域，探讨了从车联网通信向共享世界模型（SWMs）的演进。研究分析了协作感知与规划的技术现状，并指出了当前方法在实时安全保障和评估协议方面的局限性，为未来可验证的共享状态与稳健协同研究指明了方向。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>49. Planning-aligned Token Compression for Long-Context Autonomous Driving</strong><br><span>Zhixuan Liang, Yuxiao Chen, Yurong You, Peter Karkus, Wenhao Ding, Boyi Li, Alexander Popov, Yan Wang, Maximilian Igl, Yiming Li, Danfei Xu, Nikolai Smolyanskiy, Boris Ivanovic, Ping Luo, Marco Pavone</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-06-05</div><div>2026-06-05</div><div><a href="http://arxiv.org/abs/2606.07464v1">2606.07464v1</a> / <a href="https://arxiv.org/pdf/2606.07464v1">PDF</a></div><div>cs.RO, cs.AI, cs.CV</div></td>
      <td style="width: 10%; vertical-align: top;"></td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>单体视觉-动作模型是自动驾驶领域的一种新兴范式。然而，当此类架构为复杂交互编码长时序上下文时，生成的标记序列会迅速超过实时计算预算。尽管线性 Transformer 和外部存储器等方法试图减轻上下文负担，但标记压缩技术因无需修改骨干网络而与现有架构最为兼容。然而，现有的压缩方法多采用基于时间衰减的规则启发式方案，且与规划任务解耦，存在丢失决策关键信息的风险。我们提出了 COMPACT-VA，这是一种基于条件 VQ-VAE 的规划对齐工作记忆框架，旨在将扩展的上下文压缩为有界的表示。压缩过程同时受到历史轨迹和学习到的规划意图的制约，前者由后验编码器在训练期间从未来轨迹中提取，后者则由先验编码器从压缩观测中预测。压缩后的记忆与预测的潜在状态拼接后输入策略网络进行端到端优化，从而实现保留决策关键信息的规划。我们在历史上下文对行为准确性至关重要的高信号动态场景（如停车、让行或通行）中进行了评估，并相应设计了行为指标。在同等标记预算下，我们的成功率提升了超过 6%（达到 68.3%），且在各项指标上均表现出持续的增长。消融实验验证了规划对齐耦合的有效性。闭环评估证实，COMPACT-VA 在保持常规驾驶性能的同时，实现了 3.3 倍的速度提升和 2.7 倍的内存节省。</td>
      <td style="width: 20%; vertical-align: top;">针对长时序自动驾驶中标记数量过大导致计算开销过高的问题，本文提出了 COMPACT-VA 框架，通过引入规划对齐的条件 VQ-VAE 压缩机制来保留决策关键信息。该方法利用规划意图引导压缩过程，在显著减少计算资源占用的同时，提升了模型在复杂交通场景下的决策成功率与推理效率。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>50. PLAN-S: Bridging Planning with Latent Style Dynamics for Autonomous Driving World Models</strong><br><span>Xiaoyun Qiu, Jingtao He, Yijie Chen, Yusong Huang, Haotian Wang, Yixuan Wang, Xinhu Zheng</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-06-04</div><div>2026-06-04</div><div><a href="http://arxiv.org/abs/2606.06014v1">2606.06014v1</a> / <a href="https://arxiv.org/pdf/2606.06014v1">PDF</a></div><div>cs.AI, cs.RO</div></td>
      <td style="width: 10%; vertical-align: top;">world model</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>潜在世界模型（LWMs）通过预测紧凑的场景动态来强化端到端自动驾驶的下游规划。然而，现有的基于LWM的规划器通常直接从纠缠的潜在表征中生成轨迹。这种紧凑的潜在空间到规划器的路径缺乏对风险、可行驶性及多样化驾驶风格偏好的显式建模，导致在最终轨迹选择前难以对驾驶风格动态进行监督、检查或调节。我们提出了PLAN-S（基于潜在风格动态的规划），这是一个面向规划器的桥接结构，通过从潜在表征中解码出受风格条件约束的四通道语义代价图，解决了这种紧凑性与可控性之间的困境。该代价图以自我状态和驾驶风格为条件，并通过两种宿主端接口作用于规划决策之前：针对回归规划器的注意力级融合和针对锚点评分规划器的奖励级融合。我们在nuScenes上的ResWorld和NAVSIM上的WoTE这两个架构不同的宿主模型上验证了PLAN-S，并保持宿主骨干网络固定以分离该桥接结构的贡献。在nuScenes上，PLAN-S在所有预测时间范围内的L2误差均低于基线，平均L2为0.55米，且3秒碰撞率相对降低了42%。在NAVSIM上，规则代价变体达到了89.4的预测驾驶模型评分（PDMS），而学习到的代价变体在基线模型难以处理的场景中提供了补充增益。消融实验表明，代价路径对更安全的轨迹选择贡献最为直接。定性结果进一步显示，PLAN-S能够生成多样化的代价图，并展现出与不同驾驶风格相符的空间一致性变化。</td>
      <td style="width: 20%; vertical-align: top;">针对现有潜在世界模型在自动驾驶规划中缺乏对风险和风格显式控制的问题，该研究提出了PLAN-S框架，通过引入受风格约束的语义代价图来优化路径规划。该方法通过注意力或奖励融合接口与不同规划器集成，在nuScenes和NAVSIM基准测试中显著提升了行驶安全性和轨迹预测准确度。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>51. Discrete-WAM: Unified Discrete Vision-Action Token Editing for World-Policy Learning</strong><br><span>Ziyang Yao, Haochen Liu, Yuncheng Jiang, Zeyu Zhu, Zibin Guo, Jingru Wang, Tianle Liu, Jianwei Cui, Kuiyuan Yang, Hongwei Xie, Jingwei Zhao, Guang Chen, Hangjun Ye</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>52. IDOL: Inverse-Dynamics-Guided Future Prediction for End-to-End Autonomous Driving</strong><br><span>Chenghao Zhang, Timin Li, Dongmei Li</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-05-29</div><div>2026-05-29</div><div><a href="http://arxiv.org/abs/2605.31476v1">2605.31476v1</a> / <a href="https://arxiv.org/pdf/2605.31476v1">PDF</a></div><div>cs.RO</div></td>
      <td style="width: 10%; vertical-align: top;">world model</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>端到端自动驾驶作为一种直接从传感器观测中学习规划的新兴范式，近年来通过世界模型方法进一步丰富，使其能够对场景演化进行显式推理。然而，仅靠未来预测并不能保证获得更好的规划，除非预测的演化能转化为与规划相关的轨迹更新。现有的许多方法在预测未来场景状态时，未能显式解码状态转换中蕴含的运动含义。因此，未来推理往往仅在描述层面有用，而与可执行的运动生成耦合较弱。为了解决这一局限性，我们提出了 IDOL，这是一种用于潜空间 BEV 世界模型端到端规划的逆动力学引导未来预测框架，其中逆动力学作为未来预测与轨迹优化之间的关键桥梁。IDOL 首先利用 BEV 世界模型预测多个未来的潜场景状态，然后应用逆动力学模型对相邻的潜状态进行解码，提取感知转换的轨迹特征，并恢复与规划相关的运动增量，从而解释潜世界如何随时间演变。这些源自逆动力学的信号被用于优化规划轨迹，将未来预测从被动的场景预演转化为可操作的规划指导。一个轻量级的闭环优化模块通过重用优化后的轨迹进行新一轮的未来感知推理，进一步提升了长程一致性。通过将逆动力学引入潜未来推理中，IDOL 加强了世界建模与规划之间的耦合。在 NAVSIM v1 和 NAVSIM v2 基准测试上的大量实验表明，IDOL 在同类方法中达到了最先进的性能。</td>
      <td style="width: 20%; vertical-align: top;">针对端到端自动驾驶中未来预测与轨迹规划耦合较弱的问题，该论文提出了 IDOL 框架，引入逆动力学作为桥梁，将潜空间中的场景演化显式转化为可操作的运动增量。通过利用逆动力学模型提取转换特征并结合闭环优化模块，该方法显著提升了规划轨迹的质量，在 NAVSIM 基准测试中表现优异。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>53. Before Parc Fermé: RL-Time Pruning for Efficient Embodied LLMs in Autonomous Driving</strong><br><span>Luca Benfenati, Ali Azimi, Matteo Risso, Fabio Carapellese, Daniele Jahier Pagliari, Alessio Burrello</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-05-29</div><div>2026-05-29</div><div><a href="http://arxiv.org/abs/2605.31256v1">2605.31256v1</a> / <a href="https://arxiv.org/pdf/2605.31256v1">PDF</a></div><div>cs.RO</div></td>
      <td style="width: 10%; vertical-align: top;">RL</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>具身大语言模型（LLMs）正越来越多地作为机器人控制流程中的推理模块，以改善人机交互，但其内存占用和生成延迟使得实时部署变得困难。模型剪枝可以降低这些成本，但对于经历多个训练阶段的控制器而言，关键问题不仅在于剪枝多少，还在于何时剪枝。在本研究中，我们提出了“Before Parc Fermé”（BPF）策略，这是一种在强化学习（RL）期间执行的剪枝方案，旨在压缩仍在优化闭环行为的具身LLM控制器。该方法使得剪枝决策能够考虑到塑造最终控制器的任务特定监督和闭环反馈。我们提出了两种变体：BPF-RL，通过在预定义的训练间隔移除模型部分来进行迭代剪枝；以及BPF-SFT/RL，先在有监督微调（SFT）阶段剪枝部分结构，随后在RL期间继续压缩直到达到目标剪枝比率。我们在基于LLM的自动驾驶控制流程RobotxR1上使用LLM-Pruner框架评估了BPF，并将其与训练后剪枝、带RL恢复的训练后剪枝、SFT阶段剪枝及同系列较小稠密模型进行了比较。结果表明，在考虑的所有剪枝策略中，BPF在任务性能与内存及吞吐量之间提供了最佳的权衡。在压缩大型RobotxR1模型时，BPF-SFT/RL实现的规模与端到端性能权衡比直接选择同系列较小稠密模型提升了1.69倍（按每损失一个百分点控制适应度所移除的参数量衡量）。在目标机器人平台的Jetson AGX Orin上，紧凑模型使解码吞吐量提升了最高27%。</td>
      <td style="width: 20%; vertical-align: top;">本文针对自动驾驶中具身大模型部署的内存与延迟瓶颈，提出了一种在强化学习训练过程中进行剪枝的策略BPF。该方法通过在闭环优化期间动态调整模型结构，在保持任务性能的同时显著降低了模型规模并提升了推理吞吐量，优于传统的训练后剪枝方案。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>54. NTR: Neural Token Reconstruction for Scene Token Bottleneck in End-to-End Driving</strong><br><span>Jiahui Li, Jiawei Sun, Zixiang Ren, Ming Liu, Jiamin Shi, Ruiteng Zhao, Zhiyang Liu, Liying Liu, Zuoguan Wang, Kaidi Yang</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-05-29</div><div>2026-05-29</div><div><a href="http://arxiv.org/abs/2605.31116v1">2605.31116v1</a> / <a href="https://arxiv.org/pdf/2605.31116v1">PDF</a></div><div>cs.CV, cs.RO</div></td>
      <td style="width: 10%; vertical-align: top;">distillation</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>近期的无感知端到端自动驾驶方法通过将密集的图像块 Token 压缩为紧凑的场景 Token，从而绕过了显式的感知输出，直接用于后续的轨迹生成与评分。然而，尽管这些场景 Token 为规划器构成了紧凑的视觉瓶颈，但它们仅受到规划目标的监督，导致对编码视觉信息的约束有限。为了解决这一局限性，我们引入了神经 Token 重建（NTR），这是一个直接约束无感知驾驶中紧凑场景 Token 瓶颈的表征学习框架。NTR 引入了一种自蒸馏掩码潜在重建目标，仅利用紧凑的场景 Token 作为重建记忆来恢复被掩码的块级潜在特征。这强制重建梯度完全通过场景 Token 瓶颈，从而促使场景 Token 为规划保留更丰富且冗余度更低的视觉表征。我们进一步引入了源自基础模型标注的语义先验，作为一种弱语义接口，在不引入显式感知头的情况下，将重建目标偏向于驾驶相关的结构。推理时，所有辅助重建组件都会被移除，部署的规划器保持不变。NTR 在三个公开自动驾驶基准测试上实现了最先进的性能，包括在 Waymo E2E 上达到 8.0461 RFS，以及在 NavSim1&amp;2 上达到 94.1 PDMS / 90.9 EPDMS。所学习的场景 Token 展示出更低的成对冗余度和更高的有效秩，表明有效的瓶颈监督提升了紧凑视觉表征学习和规划性能。</td>
      <td style="width: 20%; vertical-align: top;">针对无感知端到端自动驾驶中场景 Token 瓶颈缺乏约束的问题，本文提出了神经 Token 重建（NTR）框架。该方法通过引入自蒸馏掩码潜在重建目标和弱语义先验，迫使场景 Token 编码更丰富、冗余度更低的视觉信息。实验结果表明，该方法在多个基准测试中均取得了最优性能，显著提升了驾驶规划的表征质量。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>55. DriveWAM: Video Generative Priors Enable Scalable World-Action Modeling for Autonomous Driving</strong><br><span>Chen Shi, Jinrui Xu, Shaoshuai Shi, Kehua Sheng, Bo Zhang, Li Jiang</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-05-27</div><div>2026-05-27</div><div><a href="http://arxiv.org/abs/2605.28544v1">2605.28544v1</a> / <a href="https://arxiv.org/pdf/2605.28544v1">PDF</a></div><div>cs.CV</div></td>
      <td style="width: 10%; vertical-align: top;">VLM</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>预训练基础模型已成为端到端自动驾驶的重要基石。与主要在静态图文对上预训练的视觉语言模型不同，视频生成模型捕捉了天然适合驾驶场景的时序动态和运动先验。我们提出了 DriveWAM，这是一种驾驶世界-动作模型，它将预训练的视频扩散 Transformer 适配为自回归的视频-动作策略。DriveWAM 将视频流和动作流组织成统一的时序 Token 序列，并在联合流匹配目标下进行训练，在保留预训练视频生成架构的同时，将其大规模视频先验适配到动作生成中。为了结合高层场景理解，我们引入了场景演化驾驶引导，利用冻结的视觉语言模型（VLM）生成特定片段的语义意图以指导视频-动作的生成。为了使长时程预测保持稳定，我们进一步引入了选择性 KV 内存，在推理时通过相关性-冗余性缓存选择来维护有界的模态感知视频和动作内存池。在 NAVSIM 和 PhysicalAI-Autonomous-Vehicles 基准测试上的实验表明，DriveWAM 实现了强大的规划性能，从 4k 到 100k 驾驶片段的数据扩展研究进一步证实了世界-动作建模在端到端自动驾驶中的扩展潜力。</td>
      <td style="width: 20%; vertical-align: top;">针对自动驾驶任务，该论文提出了 DriveWAM，这是一种通过将预训练的视频扩散模型适配为视频-动作策略的端到端世界-动作模型。该方法通过引入场景语义引导和选择性 KV 内存机制，实现了对驾驶环境的有效理解及长时程规划，并在大规模驾驶数据上验证了其出色的扩展性能。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>56. SparseWorld: Enhancing End-to-End Autonomous Driving via World Models with Sparse Scene Representation</strong><br><span>Ruoyu Wang, Jingke Wang, Yukai Ma, Yuehao Huang, Shuangming Lei, Guanglin Xu, Aixue Ye, Yong Liu</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-05-23</div><div>2026-05-23</div><div><a href="http://arxiv.org/abs/2605.24354v1">2605.24354v1</a> / <a href="https://arxiv.org/pdf/2605.24354v1">PDF</a></div><div>cs.CV</div></td>
      <td style="width: 10%; vertical-align: top;">world model</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>最近，世界模型通过未来情境预测和改进场景理解，在增强端到端自动驾驶系统方面取得了显著进展。然而，现有的驾驶世界模型通常建立在密集场景表示之上，导致计算成本高昂且存在冗余信息。在本文中，我们提出了 SparseWorld，这是一个轻量级世界模型，专注于仅预测场景的关键布局，从而为端到端驾驶系统实现高效的未来预测。SparseWorld 首先执行自回归展开来预测未来的地图元素和周围参与者，使模型能够学习驾驶场景如何随时间演变。然后，它利用这些预测的未来来优化下游的运动预测和轨迹规划。具体而言，我们提出了一个稀疏梦想家（Sparse Dreamer），通过联合时空注意力机制在潜在空间中预判未来实例。通过与预测的未来实例交互，运动规划器能够捕获更准确的运动模式，并生成更具信息量和安全意识的轨迹。大量实验表明，SparseWorld 显著降低了碰撞风险，并在 nuScenes 数据集的开环规划指标上达到了 0.05% 的碰撞率，取得了最先进的性能。此外，它在 Bench2Drive 基准测试的闭环规划指标上也大幅优于基线方法。</td>
      <td style="width: 20%; vertical-align: top;">针对现有自动驾驶世界模型基于密集表示导致计算资源冗余的问题，本研究提出了 SparseWorld 轻量级模型，通过预测关键场景布局来实现高效的未来情境预测。该模型引入稀疏梦想家（Sparse Dreamer）模块，在潜在空间进行时空建模，有效提升了下游运动规划的准确性与安全性。实验结果表明，该方法在 nuScenes 和 Bench2Drive 等基准测试中均表现出优异的规划性能并显著降低了碰撞风险。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>57. ChainFlow-VLA: Causal Flow Planning with Vision-Language Models</strong><br><span>Xiyang Wang, Xinlin Wang, Tingguang Zhou, Gong Chen, Xingtai Gui, Zhi Xu, Xiaolei Wu, Feiyang Tan, Hangning Zhou, Mu Yang</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-05-22</div><div>2026-05-22</div><div><a href="http://arxiv.org/abs/2605.23270v1">2605.23270v1</a> / <a href="https://arxiv.org/pdf/2605.23270v1">PDF</a></div><div>cs.CV, cs.AI, cs.RO</div></td>
      <td style="width: 10%; vertical-align: top;">VLM</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>当前的端到端自动驾驶系统从根本上受到时间因果推理与全局轨迹一致性之间不匹配的限制。自回归（AR）模型通过因果分解捕捉交互感知的时间依赖性，但其逐步解码导致了误差累积和次优的全局结构。相比之下，扩散模型虽然对轨迹进行全局优化，却缺乏明确的因果约束，在交互式和安全关键场景下表现不可靠。这种二分法揭示了一个更深层的问题：现有方法将因果建模和全局优化视为独立的范式，缺乏在单一轨迹分布中统一两者的原则性方法。为此，我们提出了 ChainFlow-VLA，它在统一的概率框架内整合了因果生成和全局细化。我们将规划表述为 AR 诱导模态的混合，并学习以视觉语言模型（VLM）为条件的模态残差分布。自回归生成器（Chain）产生一组离散的因果轨迹模态，随后基于扩散的细化器（Flow）利用 VLM 隐藏状态作为语义先验，在保持因果结构的同时在残差空间内执行模态条件下的修正。这种直接的条件设置将高级场景理解无缝注入到细粒度的轨迹调整中。实验表明，ChainFlow-VLA 在模糊和长尾场景中实现了稳健的规划，在 NAVSIM v1 排行榜上获得了 94.85 的最先进分数，达到了人类水平的表现（94.8）。</td>
      <td style="width: 20%; vertical-align: top;">针对自动驾驶中因果推理与全局轨迹一致性难以兼顾的问题，本文提出了 ChainFlow-VLA 框架。该方法结合了自回归生成器的因果建模能力与扩散模型的全局优化能力，并引入 VLM 作为语义先验进行轨迹细化。实验结果表明，该模型在复杂场景下的规划能力达到了人类水平。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>58. LVDrive: Latent Visual Representation Enhanced Vision-Language-Action Autonomous Driving Model</strong><br><span>Xiaodong Mei, Diankun Zhang, Hongwei Xie, Guang Chen, Hangjun Ye, Dan Xu</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-05-21</div><div>2026-05-21</div><div><a href="http://arxiv.org/abs/2605.22089v1">2605.22089v1</a> / <a href="https://arxiv.org/pdf/2605.22089v1">PDF</a></div><div>cs.CV, cs.AI</div></td>
      <td style="width: 10%; vertical-align: top;">world model</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>视觉-语言-动作（VLA）模型已成为端到端自动驾驶的一种有前景的框架。然而，现有的VLA模型通常依赖稀疏的动作监督，未能充分利用其强大的场景理解和推理能力。近期尝试通过世界模型引入密集视觉监督的方法，往往过于强调像素级的图像重建，而忽略了语义上有意义的场景表征学习。在本文中，我们提出了LVDrive，一个用于自动驾驶的潜在视觉表征增强型VLA框架。LVDrive在VLA范式中引入了未来场景预测任务，通过预训练视觉骨干网络的辅助监督，在高级潜在空间中学习未来表征。不同于低效的自回归生成，我们将未来场景和运动预测在统一的嵌入空间中联合建模，并通过单次前向传递进行未来感知推理。我们进一步设计了一种两阶段轨迹解码策略，明确利用学习到的潜在未来表征来优化轨迹生成。在具有挑战性的Bench2Drive基准测试上的大量实验表明，LVDrive在闭环驾驶性能上取得了显著提升，优于动作监督方法和基于图像重建的世界模型方法。</td>
      <td style="width: 20%; vertical-align: top;">针对当前自动驾驶VLA模型在利用场景理解能力和高效预测方面的不足，本文提出了LVDrive框架。该方法通过在潜在空间内联合建模未来场景与运动预测，并引入两阶段轨迹解码策略，实现了更精准的决策。实验证明，该模型在闭环自动驾驶性能上优于现有的动作监督及图像重建方案。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>59. Distill to Think, Foresee to Act: Cognitive-Physical Reinforcement Learning for Autonomous Driving</strong><br><span>Yang Wu, Qiang Meng, Zhaojiang Liu, Youquan Liu, Jian Yang, Jin Xie</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-05-20</div><div>2026-05-22</div><div><a href="http://arxiv.org/abs/2605.21139v2">2605.21139v2</a> / <a href="https://arxiv.org/pdf/2605.21139v2">PDF</a></div><div class="old-versions">旧版：<a href="http://arxiv.org/abs/2605.21139v1">v1</a></div><div>cs.CV, cs.LG</div></td>
      <td style="width: 10%; vertical-align: top;">VLM, world model, distillation, RL</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>当前端到端自动驾驶模型从根本上受到模仿学习中行为克隆上限的限制。虽然强化学习为实现更智能的自动驾驶提供了路径，但它缺少两个关键基础设施：(1) 理解交通语义和驾驶意图的认知基础，以及 (2) 能够预见候选动作后果的物理预测环境。为此，我们提出了 CoPhy，一种用于自动驾驶的认知-物理强化学习框架。为了实现“蒸馏以思考”，我们将视觉语言模型（VLM）知识蒸馏到鸟瞰图（BEV）编码器中，随后完全舍弃 VLM，在零推理成本下保留认知能力，并将认知通道作为可选人类语言指令的可插拔接口。为了实现“预见以行动”，我们构建了一个自回归 BEV 世界模型，能够根据候选动作显式预测未来的语义地图，作为可直接导出安全指标的物理沙箱。基于此双重基础设施，我们通过 GRPO 优化驾驶策略，并采用一种新型双重奖励机制：由 BEV 预测推导出的物理奖励强化了硬性安全约束，而源自语言对齐评分器的认知奖励确保了意图的一致性。大量实验表明，CoPhy 不仅在 NAVSIM v1 和 v2 基准测试中取得了最先进的成果，还通过认知引导的场景合规性实现了更安全的驾驶，并支持通过用户定义的语言指令进行灵活的意图控制。</td>
      <td style="width: 20%; vertical-align: top;">针对端到端自动驾驶模型在模仿学习中的局限性，本文提出了 CoPhy 框架，通过将 VLM 知识蒸馏至 BEV 编码器以赋予模型认知能力，并利用自回归世界模型预测未来场景以辅助决策。该方法结合了物理安全约束与语言意图导向的奖励机制，显著提升了自动驾驶系统在 NAVSIM 基准测试中的性能、安全性和灵活性。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>60. VL-DPO: Vision-Language-Guided Finetuning for Preference-Aligned Autonomous Driving</strong><br><span>Zhefan Xu, Ghassen Jerfel, Marina Haliem, Qi Zhao, Jeonhyung Kang, Khaled S. Refaat</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-05-19</div><div>2026-05-19</div><div><a href="http://arxiv.org/abs/2605.20082v1">2605.20082v1</a> / <a href="https://arxiv.org/pdf/2605.20082v1">PDF</a></div><div>cs.CV, cs.AI</div></td>
      <td style="width: 10%; vertical-align: top;">VLM</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>自动驾驶数据集的快速增长推动了强大的运动预测模型的发展。尽管大规模预训练提供了出色的性能，但标准的模仿学习目标可能无法完全捕捉人类驾驶偏好的复杂细微之处。与此同时，视觉语言模型（VLM）的最新进展展示了其令人印象深刻的推理和常识理解能力。基于这些能力，本文提出了VL-DPO，这是一个视觉语言引导的框架，旨在使自动驾驶车辆运动预测模型与人类偏好对齐。我们的方法利用VLM作为零样本推理器，自动从预训练模型的输出中生成偏好对，随后通过直接偏好优化（DPO）对模型进行微调。我们在Waymo端到端自动驾驶数据集（WOD-E2E）上微调模型，并使用评分反馈分数（RFS）和平均位移误差（ADE）对照保留的人类偏好标注评估性能。实验证实，VLM的轨迹选择是人类偏好的高质量代理。我们的最终模型VL-DPO在RFS上比预训练模型提高了11.94%，在ADE上降低了10.01%。</td>
      <td style="width: 20%; vertical-align: top;">针对现有自动驾驶运动预测模型难以完全契合人类驾驶偏好的问题，本文提出了一种基于视觉语言模型（VLM）引导的微调框架VL-DPO。该方法利用VLM自动生成偏好对，并通过直接偏好优化（DPO）对模型进行对齐，有效提升了轨迹预测的质量及与人类偏好的一致性。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>61. HEAT: Heterogeneous End-to-End Autonomous Driving via Trajectory-Guided World Models</strong><br><span>Hoonhee Cho, Giwon Lee, Jae-Young Kang, Hyemin Yang, Heejun Park, Kuk-Jin Yoon</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-05-19</div><div>2026-05-19</div><div><a href="http://arxiv.org/abs/2605.19631v1">2605.19631v1</a> / <a href="https://arxiv.org/pdf/2605.19631v1">PDF</a></div><div>cs.RO, cs.CV</div></td>
      <td style="width: 10%; vertical-align: top;">world model</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>端到端自动驾驶已成为传统模块化方案的一种极具吸引力的替代方案，它能直接将原始传感器数据映射为驾驶动作。尽管最近的方法在单域数据集上表现出色，但在多个异构域上联合训练时，性能会显著下降。然而在实践中，自动驾驶系统必须在包括不同城市、传感器配置和交通模式等具有异构分布的多样化环境中运行，且无需针对特定域进行再训练。这一差距突显了多域学习中的一个核心挑战：异构域间的特定变化引入了冲突的学习信号，导致模型倾向于得出在各域中表现均欠佳的折中方案。为了解决这一问题，我们提出了一种以轨迹为驱动的学习范式，围绕规划轨迹组织训练，使模型能够捕捉到驾驶意图的域不变表示。此外，我们结合了一个以自车动作为条件的未来潜空间特征预测世界模型，从而提高了特征的一致性并减轻了域诱导的偏差。我们在nuScenes、NAVSIM和Waymo端到端数据集这三个基准上评估了我们的方法，并证明其在所有域中均显著优于现有方法。研究结果表明，单个统一模型可以在异构数据集上进行训练，同时保持各域内的强大性能，这标志着向可扩展的现实世界部署迈出了一步。</td>
      <td style="width: 20%; vertical-align: top;">针对自动驾驶模型在多异构域联合训练时性能下降的问题，本文提出了一种基于轨迹引导和世界模型的端到端学习框架。通过引入轨迹驱动的学习范式与条件化未来特征预测，该方法有效缓解了跨域冲突信号，显著提升了模型在不同驾驶场景下的通用性与任务性能。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>62. SafeAlign-VLA: A Negative-Enhanced Safe Alignment Framework for Risk-Aware Autonomous Driving</strong><br><span>Kefei Tian, Yuansheng Lian, Kai Yang, Xiangdong Chen, Shen Li</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-05-19</div><div>2026-05-19</div><div><a href="http://arxiv.org/abs/2605.19524v1">2605.19524v1</a> / <a href="https://arxiv.org/pdf/2605.19524v1">PDF</a></div><div>cs.RO, cs.CV</div></td>
      <td style="width: 10%; vertical-align: top;">RL</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>端到端自动驾驶系统在常见场景中表现出色，但在安全关键的长尾案例中却面临挑战。视觉-语言-动作（VLA）模型因其强大的推理能力而备受期待。然而，大多数基于 VLA 的方法主要依赖正向专家演示，很少利用负面样本，导致对风险行为和安全边界的理解不足。为了解决这一局限性，我们提出了 SafeAlign-VLA，这是一个统一的负增强安全对齐框架，将负面数据纳入监督学习和强化学习中。首先，我们开发了一种反事实安全配对范式，通过反事实推理从风险场景中生成结构化安全标签和反事实正向轨迹。随后，采用两阶段训练策略：首先进行负增强监督微调以实现失败反馈和轨迹纠正，随后采用基于锚点的组相对策略优化，利用正负轨迹作为对比锚点来引导采样，并通过组相对优势惩罚高风险行为。在 NAVSIM 和 DeepAccident 上的实验验证了该框架的有效性。SafeAlign-VLA 在 NAVSIM v1 测试集上达到了 89.1 的 PDMS，比不使用负面数据的基线提高了 1.3%。在 DeepAccident 上，它将碰撞率降低至 3.36%，同时达到了 84.2% 的语言准确率和 85.8% 的风险预测准确率。这些结果证明了所提出的负增强安全对齐框架对于实现安全稳健的自动驾驶的有效性。</td>
      <td style="width: 20%; vertical-align: top;">针对自动驾驶在处理安全关键长尾案例时对风险理解不足的问题，本文提出了 SafeAlign-VLA 框架。该方法通过反事实推理生成负面样本，并采用负增强监督微调与基于对比锚点的强化学习，显著提高了系统对高风险行为的识别与避障能力。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>63. Xiaomi EV World Model: A Joint World Model Integrating Reconstruction and Generation for Autonomous Driving</strong><br><span>Lijun Zhou, Hongcheng Luo, Zhenxin Zhu, Cheng Chi, Mingfei Tu, Kaixin Xiong, Lei Gong, Zhanqian Wu, Zehan Zhang, Fangzhen Li, Hao Li, Yingying Shen, Jiale He, Haohui Zhu, Shan Zhao, Kai Wang, Zhiwei Zhan, Yuechuan Pu, Kaiyuan Tan, Ruiling Yang, Xianqi Wang, Tianyi Yan, Jiawei Zhou, Lei Zhang, Jingyang Zhao, Xi Zhou, Chitian Sun, Chenming Wu, Jiong Deng, Hongwei Xie, Ming Lu, Kun Ma, Long Chen, Guang Chen, Hangjun Ye, Bing Wang, Haiyang Sun</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-05-18</div><div>2026-05-19</div><div><a href="http://arxiv.org/abs/2605.18137v2">2605.18137v2</a> / <a href="https://arxiv.org/pdf/2605.18137v2">PDF</a></div><div class="old-versions">旧版：<a href="http://arxiv.org/abs/2605.18137v1">v1</a></div><div>cs.CV</div></td>
      <td style="width: 10%; vertical-align: top;">world model, distillation</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>本报告提出了一个统一的技术系统，旨在解决自动驾驶世界模型的核心能力：世界表征与世界生成。在世界表征方面，我们提出了 WorldRec，这是一种由稀疏场景查询驱动的前馈重建架构。WorldRec 在 3D 空间中初始化结构化查询，利用它们聚合跨视图、跨时间的特征，从而自然地增强了帧间的空间一致性，并生成紧凑且高保真的 3D 高斯场景表示。在世界生成方面，我们提出了 WorldGen，这是一个包含双向预训练和因果微调的两阶段训练框架，通过三个循序渐进的阶段（教师强制、ODE 蒸馏和 DMD），实现了低至 4 步去噪的高质量在线因果视频生成。基于这两个模块，我们进一步引入了 JWM，深度整合了 WorldRec 和 WorldGen，以在生成稳定性、帧间一致性和视觉保真度方面实现协同增效，为自动驾驶的闭环仿真、数据合成和端到端训练提供了坚实基础。</td>
      <td style="width: 20%; vertical-align: top;">针对自动驾驶中的世界表征与生成问题，本文提出了集成 WorldRec 重建架构与 WorldGen 生成框架的 JWM 系统。该系统通过 3D 高斯场景表示与分阶段高效去噪生成，显著提升了视频生成的一致性、稳定性和保真度，为自动驾驶仿真与训练提供了支持。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>64. CLOVER: Closed-Loop Value Estimation and Ranking for End-to-End Autonomous Driving Planning</strong><br><span>Sining Ang, Yuguang Yang, Canyu Chen, Yan Wang</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>65. MAPLE: Latent Multi-Agent Play for End-to-End Autonomous Driving</strong><br><span>Rajeev Yasarla, Deepti Hegde, Hsin-Pai Cheng, Shizhong Han, Yunxiao Shi, Meysam Sadeghigooghari, Hanno Ackermann, Litian Liu, Pranav Desai, Fatih Porikli, Mohammad Ghavamzadeh, Hong Cai</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-05-13</div><div>2026-05-13</div><div><a href="http://arxiv.org/abs/2605.14201v1">2605.14201v1</a> / <a href="https://arxiv.org/pdf/2605.14201v1">PDF</a></div><div>cs.RO, cs.CV</div></td>
      <td style="width: 10%; vertical-align: top;">RL</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>视觉-语言-动作（VLA）模型作为端到端运动规划器非常有效，但由于在传统的模仿学习框架下进行训练，在闭环设置中评估时可能表现得不够稳健。现有的闭环监督方法缺乏可扩展性，且无法完全建模反应式环境。我们提出了 MAPLE，这是一个用于在 VLA 模型的潜在空间中进行动态驾驶场景的反应式、多智能体演练的新颖框架。自动驾驶车辆和附近的交通智能体在多步时间范围内被独立控制，同时对场景中的其他智能体做出反应，从而实现闭环训练。MAPLE 包含两个训练阶段：（1）基于真实轨迹的潜在演练的监督微调，随后（2）通过全局和智能体特定的奖励进行强化学习，以鼓励安全性、进度和交互真实性。我们进一步提出了多样性奖励，鼓励模型生成日志驾驶数据中可能不存在的规划行为。值得注意的是，我们的闭环训练框架具有可扩展性，不需要外部模拟器，因为外部模拟器在运行上计算成本高昂且在真实世界的视觉保真度上有限。MAPLE 在 Bench2Drive 上实现了最先进的驾驶性能，并为稳健的端到端自动驾驶系统展示了可扩展的、闭环的多智能体博弈。</td>
      <td style="width: 20%; vertical-align: top;">针对端到端自动驾驶模型在闭环环境下的稳健性不足问题，该论文提出了 MAPLE 框架，通过在 VLA 模型潜在空间中进行多智能体交互式演练进行训练。该方法结合了监督微调与包含多样性奖励的强化学习，无需依赖外部模拟器即可实现可扩展的闭环训练。实验结果表明，MAPLE 在 Bench2Drive 基准测试中达到了领先性能，有效提升了自动驾驶系统的交互与规划能力。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>66. MindVLA-U1: VLA Beats VA with Unified Streaming Architecture for Autonomous Driving</strong><br><span>Yuzhou Huang, Benjin Zhu, Hengtong Lu, Victor Shea-Jay Huang, Haiming Zhang, Wei Chen, Jifeng Dai, Yan Xie, Hongsheng Li</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-05-12</div><div>2026-05-14</div><div><a href="http://arxiv.org/abs/2605.12624v2">2605.12624v2</a> / <a href="https://arxiv.org/pdf/2605.12624v2">PDF</a></div><div class="old-versions">旧版：<a href="http://arxiv.org/abs/2605.12624v1">v1</a></div><div>cs.RO, cs.CV</div></td>
      <td style="width: 10%; vertical-align: top;">VLM</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>自动驾驶已从模块化流程转向端到端统一，而视觉-语言-动作（VLA）模型是这一趋势超越单纯视觉-动作（VA）模型的自然延伸。在实践中，驾驶类 VLA 模型在规划质量上往往落后于 VA，这表明问题不在于模型规模，而在于结合语义推理、时间上下文与连续控制的接口方式。我们认为，这一差距反映了 VLA 的构建方式——即将其视为孤立的子任务改进，从而无法形成连贯的驾驶能力，而非 VLA 本身的问题。我们提出了 MindVLA-U1，这是首个用于自动驾驶的统一流式 VLA 架构。统一的 VLM 主干在单一前向传播中基于共享表示生成自回归语言 Token（可选）和流匹配连续动作轨迹，保持了各模态的原始输出形式。完整的流式设计以帧为单位处理驾驶视频，而非在昂贵的时间 VLM 建模下处理固定的视频-动作块。规划的轨迹在帧间平滑演变，同时通过学习到的流式记忆通道携带和更新时间上下文。该统一架构通过灵活的自注意力上下文管理，在密集和稀疏的多对象追踪（MoT）主干上实现了快/慢系统，并为动作暴露了一条可衡量的语言-控制路径：语言预测的驾驶意图通过无分类器引导（CFG）驱动动作扩散，将语言端的意图转化为连续动作规划的控制信号。在长尾 WOD-E2E 基准测试中，MindVLA-U1 在 2 步扩散下首次超越了人类驾驶员的表现（RFS 为 8.20，而人类 GT RFS 为 8.13），在规划 ADE 指标上大幅超越了此前的 VA/VLA 模型，并在保持人车交互自然语言接口的同时，达到了与 VA 相当的延迟（1B 参数规模下为 16 FPS，而 RAP 为 18 FPS）。</td>
      <td style="width: 20%; vertical-align: top;">针对自动驾驶 VLA 模型规划质量不足且处理效率低的问题，本文提出了 MindVLA-U1 统一流式架构。该方法通过以帧为单位的流式处理与共享表征，实现了语言与动作的同步生成及平滑轨迹规划。实验证明，该架构在达到实时驾驶延迟的同时，在长尾驾驶任务中的表现首次超过了人类水平。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>67. DeepSight: Long-Horizon World Modeling via Latent States Prediction for End-to-End Autonomous Driving</strong><br><span>Lingjun Zhang, Changjie Wu, Linzhe Shi, Jiangyang Li, Jiaxin Liu, Lei Yang, Hang Zhang, Mu Xu, Hong Wang</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>68. CoWorld-VLA: Thinking in a Multi-Expert World Model for Autonomous Driving</strong><br><span>Minqing Huang, Yujiao Xiang, Zihan Liang, Jiajie Huang, Jingqi Wang, Zhi Xu, Feiyang Tan, Hangning Zhou, Mu Yang, Gong Che</span></td>
      <td style="width: 13%; vertical-align: top;"><div>2026-05-11</div><div>2026-05-13</div><div><a href="http://arxiv.org/abs/2605.10426v2">2605.10426v2</a> / <a href="https://arxiv.org/pdf/2605.10426v2">PDF</a></div><div class="old-versions">旧版：<a href="http://arxiv.org/abs/2605.10426v1">v1</a></div><div>cs.CV, cs.AI</div></td>
      <td style="width: 10%; vertical-align: top;">world model</td>
      <td style="width: 34%; vertical-align: top;"><strong>中文摘要</strong><br>视觉-语言-动作（VLA）模型已成为端到端自动驾驶的一种有前途的范式。然而，现有的推理机制在提供面向规划的中间表征方面仍存在困难：文本思维链（CoT）无法保留连续的时空结构，而潜在的世界推理仍难以直接作为动作生成的条件。在本文中，我们提出了 CoWorld-VLA，这是一种用于自动驾驶的多专家世界推理框架，其中世界表征作为引导动作规划的显式条件。CoWorld-VLA 通过多源监督提取互补的世界信息，并将其编码为 VLA 中的专家标记，从而提供规划器可访问的条件信号。具体而言，我们构建了四种类型的标记：语义交互、几何结构、动态演化和自车轨迹标记，分别对交互意图、空间结构、未来时间动态和行为目标进行建模。在动作生成过程中，CoWorld-VLA 采用了一种基于扩散的分层多专家融合规划器，该规划器在整个联合去噪过程中与场景上下文相结合，以生成连续的自车轨迹。实验表明，CoWorld-VLA 在 NAVSIM v1 基准测试的未来场景生成和规划方面均取得了具有竞争力的结果，在防碰撞和轨迹准确性方面表现出强大的性能。消融实验进一步验证了专家标记的互补性及其作为动作生成规划条件的有效性。代码地址：https://github.com/AFARI-Research/CoWorld-VLA。</td>
      <td style="width: 20%; vertical-align: top;">针对自动驾驶中现有 VLA 模型难以获取有效的面向规划的中间表征的问题，本研究提出了 CoWorld-VLA 框架。该方法通过引入四种互补的专家标记来建模时空信息，并结合基于扩散的分层规划器进行动作生成。实验结果证明，该方法能显著提升自动驾驶中的轨迹准确性和防碰撞能力。</td>
    </tr>
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>69. MTA-RL: Robust Urban Driving via Multi-modal Transformer-based 3D Affordances and Reinforcement Learning</strong><br><span>Guangli Chen, Dianzhao Li, Wenjian Zhong, Bangquan Xie, Ostap Okhrin</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>70. DriveFuture: Future-Aware Latent World Models for Autonomous Driving</strong><br><span>Yufeng Hong, Xiaotian Zhou, Yingyan Li, Xiangpo Zhou, Lin Liu, Yadan Luo, Shaoqing Xu, Lei Yang, Ziying Song</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>71. See Tomorrow, Act Today: Foresight-Driven Autonomous Driving</strong><br><span>Bozhou Zhang, Nan Song, Yuang Wang, Jiankang Deng, Xiatian Zhu, Li Zhang</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>72. GSDrive: Reinforcing Driving Policies by Multi-mode Trajectory Probing with 3D Gaussian Splatting Environment</strong><br><span>Ziang Guo, Chen Min, Xuefeng Zhang, Yixiao Zhou, Zufeng Zhang, Dzmitry Tsetserukou</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>73. ProDrive: Proactive Planning for Autonomous Driving via Ego-Environment Co-Evolution</strong><br><span>Chuyao Fu, Shengzhe Gan, Zhuoli Ouyang, Yuhan Rui, Xiaowei Chi, Sirui Han, Jiankun Wang, Hong Zhang</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>74. Reasoning About Traversability: Language-Guided Off-Road 3D Trajectory Planning</strong><br><span>Byounggun Park, Soonmin Hwang</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>75. SpanVLA: Efficient Action Bridging and Learning from Negative-Recovery Samples for Vision-Language-Action Model</strong><br><span>Zewei Zhou, Ruining Yang, Xuewei, Qi, Yiluan Guo, Sherry X. Chen, Tao Feng, Kateryna Pistunova, Yishan Shen, Lili Su, Jiaqi Ma</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>76. From Particles to Perils: SVGD-Based Hazardous Scenario Generation for Autonomous Driving Systems Testing</strong><br><span>Linfeng Liang, Xiao Cheng, Tsong Yueh Chen, Xi Zheng</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>78. OneDrive: Unified Multi-Paradigm Driving with Vision-Language-Action Models</strong><br><span>Yiwei Zhang, Xuesong Chen, Jin Gao, Hanshi Wang, Fudong Ge, Weiming Hu, Shaoshuai Shi, Zhipeng Zhang</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>79. Infrastructure-Centric World Models: Bridging Temporal Depth and Spatial Breadth for Roadside Perception</strong><br><span>Siyuan Meng, Chengbo Ai</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>80. Beyond Conservative Automated Driving in Multi-Agent Scenarios via Coupled Model Predictive Control and Deep Reinforcement Learning</strong><br><span>Saeed Rahmani, Gözde Körpe, Zhenlin, Xu, Bruno Brito, Simeon Craig Calvert, Bart van Arem</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>81. Learning Vision-Language-Action World Models for Autonomous Driving</strong><br><span>Guoqing Wang, Pin Tang, Xiangxuan Ren, Guodongfang Zhao, Bailan Feng, Chao Ma</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>82. LMGenDrive: Bridging Multimodal Understanding and Generative World Modeling for End-to-End Driving</strong><br><span>Hao Shao, Letian Wang, Yang Zhou, Yuxuan Hu, Zhuofan Zong, Steven L. Waslander, Wei Zhan, Hongsheng Li</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>83. Fuzzy Encoding-Decoding to Improve Spiking Q-Learning Performance in Autonomous Driving</strong><br><span>Aref Ghoreishee, Abhishek Mishra, Lifeng Zhou, John Walsh, Anup Das, Nagarajan Kandasamy</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>84. HAD: Combining Hierarchical Diffusion with Metric-Decoupled RL for End-to-End Driving</strong><br><span>Wenhao Yao, Xinglong Sun, Zhenxin Li, Shiyi Lan, Zi Wang, Jose M. Alvarez, Zuxuan Wu</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>85. ExploreVLA: Dense World Modeling and Exploration for End-to-End Autonomous Driving</strong><br><span>Zihao Sheng, Xin Ye, Jingru Luo, Sikai Chen, Liu Ren</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>86. $AutoDrive\text{-}P^3$: Unified Chain of Perception-Prediction-Planning Thought via Reinforcement Fine-Tuning</strong><br><span>Yuqi Ye, Zijian Zhang, Junhong Lin, Shangkun Sun, Changhao Peng, Wei Gao</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>87. Collision-Aware Vision-Language Learning for End-to-End Driving with Multimodal Infraction Datasets</strong><br><span>Alex Koran, Dimitrios Sinodinos, Hadi Hojjati, Takuya Nanri, Fangge Chen, Narges Armanfard</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>88. COIN: Collaborative Interaction-Aware Multi-Agent Reinforcement Learning for Self-Driving Systems</strong><br><span>Yifeng Zhang, Jieming Chen, Tingguang Zhou, Tanishq Duhan, Jianghong Dong, Yuhong Cao, Guillaume Sartoretti</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>92. DriveVLM-RL: Neuroscience-Inspired Reinforcement Learning with Vision-Language Models for Safe and Deployable Autonomous Driving</strong><br><span>Zilin Huang, Zihao Sheng, Zhengyang Wan, Yansong Qu, Junwei You, Sicong Jiang, Sikai Chen</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>93. Learning from Mistakes: Post-Training for Driving VLA with Takeover Data</strong><br><span>Yinfeng Gao, Deqing Liu, Qichao Zhang, Yupeng Zheng, Haochen Tian, Guang Li, Hangjun Ye, Long Chen, Da-Wei Ding, Dongbin Zhao</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>94. Bridging Scene Generation and Planning: Driving with World Model via Unifying Vision and Motion Representation</strong><br><span>Xingtai Gui, Meijie Zhang, Tianyi Yan, Wencheng Han, Jiahao Gong, Feiyang Tan, Cheng-zhong Xu, Jianbing Shen</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>96. AutoMoT: A Unified Vision-Language-Action Model with Asynchronous Mixture-of-Transformers for End-to-End Autonomous Driving</strong><br><span>Wenhui Huang, Songyan Zhang, Qihang Huang, Zhidong Wang, Zhiqi Mao, Collister Chua, Zhan Chen, Long Chen, Chen Lv</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>97. WorldVLM: Combining World Model Forecasting and Vision-Language Reasoning</strong><br><span>Stefan Englmeier, Katharina Winter, Fabian B. Flohr</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>98. Fine-tuning is Not Enough: A Parallel Framework for Collaborative Imitation and Reinforcement Learning in End-to-end Autonomous Driving</strong><br><span>Zhexi Lian, Haoran Wang, Xuerun Yan, Weimeng Lin, Xianhong Zhang, Yongyu Chen, Jia Hu</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>99. FlowAD: Ego-Scene Interactive Modeling for Autonomous Driving</strong><br><span>Mingzhe Guo, Yixiang Yang, Chuanrong Han, Rufeng Zhang, Shirui Li, Ji Wan, Zhipeng Zhang</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>100. Open-World Motion Forecasting</strong><br><span>Nicolas Schischka, Nikhil Gosala, B Ravi Kiran, Senthil Yogamani, Abhinav Valada</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>101. NaviDriveVLM: Decoupling High-Level Reasoning and Motion Planning for Autonomous Driving</strong><br><span>Ximeng Tao, Pardis Taghavi, Dimitar Filev, Reza Langari, Gaurav Pandey</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>102. BEVLM: Distilling Semantic Knowledge from LLMs into Bird&#x27;s-Eye View Representations</strong><br><span>Thomas Monninger, Shaoyuan Xie, Qi Alfred Chen, Sihao Ding</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>103. TADPO: Reinforcement Learning Goes Off-road</strong><br><span>Zhouchonghao Wu, Raymond Song, Vedant Mundheda, Luis E. Navarro-Serment, Christof Schoenborn, Jeff Schneider</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>104. Risk-Aware World Model Predictive Control for Generalizable End-to-End Autonomous Driving</strong><br><span>Jiangxin Sun, Feng Xue, Teng Long, Chang Liu, Jian-Fang Hu, Wei-Shi Zheng, Nicu Sebe</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>106. MindDriver: Introducing Progressive Multimodal Reasoning for Autonomous Driving</strong><br><span>Lingjun Zhang, Yujian Yuan, Changjie Wu, Xinyuan Chang, Xin Cai, Shuang Zeng, Linzhe Shi, Sijin Wang, Hang Zhang, Mu Xu</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>107. Efficient and Explainable End-to-End Autonomous Driving via Masked Vision-Language-Action Diffusion</strong><br><span>Jiaru Zhang, Manav Gagvani, Can Cui, Juntong Peng, Ruqi Zhang, Ziran Wang</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>108. The Five Ws of Multi-Agent Communication: Who Talks to Whom, When, What, and Why -- A Survey from MARL to Emergent Language and LLMs</strong><br><span>Jingdi Chen, Hanqing Yang, Zongjun Liu, Carlee Joe-Wong</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>109. ResWorld: Temporal Residual World Model for End-to-End Autonomous Driving</strong><br><span>Jinqing Zhang, Zehua Fu, Zelin Xu, Wenying Dai, Qingjie Liu, Yunhong Wang</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>110. Found-RL: foundation model-enhanced reinforcement learning for autonomous driving</strong><br><span>Yansong Qu, Zihao Sheng, Zilin Huang, Jiancong Chen, Yuhao Luo, Tianyi Wang, Yiheng Feng, Samuel Labi, Sikai Chen</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>111. DriveWorld-VLA: Unified Latent-Space World Modeling with Vision-Language-Action for Autonomous Driving</strong><br><span>Feiyang jia, Lin Liu, Ziying Song, Caiyan Jia, Hangjun Ye, Xiaoshuai Hao, Long Chen</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>112. AppleVLM: End-to-end Autonomous Driving with Advanced Perception and Planning-Enhanced Vision-Language Models</strong><br><span>Yuxuan Han, Kunyuan Wu, Qianyi Shao, Renxiang Xiao, Zilu Wang, Cansen Jiang, Yi Xiao, Liang Hu, Yunjiang Lou</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>113. Natural Language Instructions for Scene-Responsive Human-in-the-Loop Motion Planning in Autonomous Driving using Vision-Language-Action Models</strong><br><span>Angel Martinez-Sanchez, Parthib Roy, Ross Greer</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>114. HERMES: A Holistic End-to-End Risk-Aware Multimodal Embodied System with Vision-Language Models for Long-Tail Autonomous Driving</strong><br><span>Weizhe Tang, Junwei You, Jiaxi Liu, Zhaoyi Wang, Rui Gan, Zilin Huang, Feng Wei, Bin Ran</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>115. Drive-JEPA: Video JEPA Meets Multimodal Trajectory Distillation for End-to-End Driving</strong><br><span>Linhan Wang, Zichong Yang, Chen Bai, Guoxiang Zhang, Xiaotong Liu, Xiaoyin Zheng, Xiao-Xiao Long, Chang-Tien Lu, Cheng Lu</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>117. SGDrive: Scene-to-Goal Hierarchical World Cognition for Autonomous Driving</strong><br><span>Jingyu Li, Junjie Wu, Dongnan Hu, Xiangkai Huang, Bin Sun, Zhihui Hao, Xianpeng Lang, Xiatian Zhu, Li Zhang</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>118. FLARE: Learning Future-Aware Latent Representations from Vision-Language Models for Autonomous Driving</strong><br><span>Chengen Xie, Chonghao Sima, Tianyu Li, Bin Sun, Junjie Wu, Zhihui Hao, Hongyang Li</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>119. FROST-Drive: Scalable and Efficient End-to-End Driving with a Frozen Vision Encoder</strong><br><span>Zeyu Dong, Yimin Zhu, Yu Wu, Yu Sun</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>120. Dichotomous Diffusion Policy Optimization</strong><br><span>Ruiming Liang, Yinan Zheng, Kexin Zheng, Tianyi Tan, Jianxiong Li, Liyuan Mao, Zhihao Wang, Guang Chen, Hangjun Ye, Jingjing Liu, Jinqiao Wang, Xianyuan Zhan</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>121. Spatial-aware Vision Language Model for Autonomous Driving</strong><br><span>Weijie Wei, Zhipeng Luo, Ling Feng, Venice Erin Liong</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>122. ColaVLA: Leveraging Cognitive Latent Reasoning for Hierarchical Parallel Trajectory Planning in Autonomous Driving</strong><br><span>Qihang Peng, Xuesong Chen, Chenye Yang, Shaoshuai Shi, Hongsheng Li</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>123. WorldRFT: Latent World Model Planning with Reinforcement Fine-Tuning for Autonomous Driving</strong><br><span>Pengxuan Yang, Ben Lu, Zhongpu Xia, Chao Han, Yinfeng Gao, Teng Zhang, Kun Zhan, XianPeng Lang, Yupeng Zheng, Qichao Zhang</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>124. Pseudo-Expert Regularized Offline RL for End-to-End Autonomous Driving in Photorealistic Closed-Loop Environments</strong><br><span>Chihiro Noguchi, Takaki Yamamoto</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>127. OmniDrive-R1: Reinforcement-driven Interleaved Multi-modal Chain-of-Thought for Trustworthy Vision-Language Autonomous Driving</strong><br><span>Zhenguo Zhang, Haohan Zheng, Yishen Wang, Le Xu, Tianchen Deng, Xuefeng Chen, Qu Chen, Bo Zhang, Wuxiong Huang</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>128. Tackling Snow-Induced Challenges: Safe Autonomous Lane-Keeping with Robust Reinforcement Learning</strong><br><span>Amin Jalal Aghdasian, Farzaneh Abdollahi, Ali Kamali Iglie</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>130. Semantic-Drive: Democratizing Long-Tail Data Curation via Open-Vocabulary Grounding and Neuro-Symbolic VLM Consensus</strong><br><span>Antonio Guillen-Perez</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>132. SpaceDrive: Infusing Spatial Awareness into VLM-based Autonomous Driving</strong><br><span>Peizheng Li, Zhenghao Zhang, David Holtz, Hang Yu, Yutong Yang, Yuzhi Lai, Rui Song, Andreas Geiger, Andreas Zell</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>133. Closing the Navigation Compliance Gap in End-to-end Autonomous Driving</strong><br><span>Hanfeng Wu, Marlon Steiner, Michael Schmidt, Alvaro Marcos-Ramiro, Christoph Stiller</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>134. Latent Chain-of-Thought World Modeling for End-to-End Driving</strong><br><span>Shuhan Tan, Kashyap Chitta, Yuxiao Chen, Ran Tian, Yurong You, Yan Wang, Wenjie Luo, Yulong Cao, Philipp Krahenbuhl, Marco Pavone, Boris Ivanovic</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>135. UniUGP: Unifying Understanding, Generation, and Planing For End-to-end Autonomous Driving</strong><br><span>Hao Lu, Ziyang Liu, Guangfeng Jiang, Yuanfei Luo, Sheng Chen, Yangang Zhang, Ying-Cong Chen</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>136. COVLM-RL: Critical Object-Oriented Reasoning for Autonomous Driving Using VLM-Guided Reinforcement Learning</strong><br><span>Lin Li, Yuxin Cai, Jianwu Fang, Jianru Xue, Chen Lv</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>137. DiffusionDriveV2: Reinforcement Learning-Constrained Truncated Diffusion Modeling in End-to-End Autonomous Driving</strong><br><span>Jialv Zou, Shaoyu Chen, Bencheng Liao, Zhiyu Zheng, Yuehao Song, Lefei Zhang, Qian Zhang, Wenyu Liu, Xinggang Wang</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>139. Spatial Retrieval Augmented Autonomous Driving</strong><br><span>Xiaosong Jia, Chenhe Zhang, Yule Jiang, Songbur Wong, Zhiyuan Zhang, Chen Chen, Shaofeng Zhang, Xuanhe Zhou, Xue Yang, Junchi Yan, Yu-Gang Jiang</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>140. WAM-Diff: A Masked Diffusion VLA Framework with MoE and Online Reinforcement Learning for Autonomous Driving</strong><br><span>Mingwang Xu, Jiahao Cui, Feipeng Cai, Hanlin Shang, Zhihao Zhu, Shan Luan, Yifang Xu, Neng Zhang, Yaoyi Li, Jia Cai, Siyu Zhu</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>141. BeLLA: End-to-End Birds Eye View Large Language Assistant for Autonomous Driving</strong><br><span>Karthik Mohan, Sonam Singh, Amit Arvind Kale</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>142. dVLM-AD: Enhance Diffusion Vision-Language-Model for Driving via Controllable Reasoning</strong><br><span>Yingzi Ma, Yulong Cao, Wenhao Ding, Shuibai Zhang, Yan Wang, Boris Ivanovic, Ming Jiang, Marco Pavone, Chaowei Xiao</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>144. RoaD: Rollouts as Demonstrations for Closed-Loop Supervised Fine-Tuning of Autonomous Driving Policies</strong><br><span>Guillermo Garcia-Cobo, Maximilian Igl, Peter Karkus, Zhejun Zhang, Michael Watson, Yuxiao Chen, Boris Ivanovic, Marco Pavone</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>145. New Spiking Architecture for Multi-Modal Decision-Making in Autonomous Vehicles</strong><br><span>Aref Ghoreishee, Abhishek Mishra, Lifeng Zhou, John Walsh, Nagarajan Kandasamy</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>146. OpenREAD: Reinforced Open-Ended Reasoning for End-to-End Autonomous Driving with LLM-as-Critic</strong><br><span>Songyan Zhang, Wenhui Huang, Zhan Chen, Chua Jiahao Collister, Qihang Huang, Chen Lv</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>147. RoboDriveVLM: A Novel Benchmark and Baseline towards Robust Vision-Language Models for Autonomous Driving</strong><br><span>Dacheng Liao, Mengshi Qi, Peng Shu, Zhining Zhang, Yuxin Lin, Liang Liu, Huadong Ma</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>148. CoT4AD: A Vision-Language-Action Model with Explicit Chain-of-Thought Reasoning for Autonomous Driving</strong><br><span>Zhaohui Wang, Tengbo Yu, Hao Tang</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>150. Map-World: Masked Action planning and Path-Integral World Model for Autonomous Driving</strong><br><span>Bin Hu, Zijian Lu, Haicheng Liao, Chengran Yuan, Bin Rao, Yongkang Li, Guofa Li, Zhiyong Cui, Cheng-zhong Xu, Zhenning Li</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>151. CoC-VLA: Delving into Adversarial Domain Transfer for Explainable Autonomous Driving via Chain-of-Causality Visual-Language-Action Model</strong><br><span>Dapeng Zhang, Fei Shen, Rui Zhao, Yinda Chen, Peng Zhi, Chenyang Li, Rui Zhou, Qingguo Zhou</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>153. Enhancing End-to-End Autonomous Driving with Risk Semantic Distillaion from VLM</strong><br><span>Jack Qin, Zhitao Wang, Yinan Zheng, Keyu Chen, Yang Zhou, Yuanxin Zhong, Siyuan Cheng</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>155. Decoupling Scene Perception and Ego Status: A Multi-Context Fusion Approach for Enhanced Generalization in End-to-End Autonomous Driving</strong><br><span>Jiacheng Tang, Mingyue Feng, Jiachao Liu, Yaonong Wang, Jian Pu</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>156. Prompt-Driven Domain Adaptation for End-to-End Autonomous Driving via In-Context RL</strong><br><span>Aleesha Khurram, Amir Moeini, Shangtong Zhang, Rohan Chandra</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>157. VLA-R: Vision-Language Action Retrieval toward Open-World End-to-End Autonomous Driving</strong><br><span>Hyunki Seong, Seongwoo Moon, Hojin Ahn, Jehun Kang, David Hyunchul Shim</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>158. FLAD: Federated Learning for LLM-based Autonomous Driving in Vehicle-Edge-Cloud Networks</strong><br><span>Tianao Xiang, Mingjian Zhi, Yuanguo Bi, Lin Cai, Yuhao Chen</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>159. Constructing the Umwelt: Cognitive Planning through Belief-Intent Co-Evolution</strong><br><span>Shiyao Sang</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>161. ZTRS: Zero-Imitation End-to-end Autonomous Driving with Trajectory Scoring</strong><br><span>Zhenxin Li, Wenhao Yao, Zi Wang, Xinglong Sun, Jingde Chen, Nadine Chang, Maying Shen, Jingyu Song, Zuxuan Wu, Shiyi Lan, Jose M. Alvarez</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>162. VR-Drive: Viewpoint-Robust End-to-End Driving with Feed-Forward 3D Gaussian Splatting</strong><br><span>Hoonhee Cho, Jae-Young Kang, Giwon Lee, Hyemin Yang, Heejun Park, Seokwoo Jung, Kuk-Jin Yoon</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>163. VGD: Visual Geometry Gaussian Splatting for Feed-Forward Surround-view Driving Reconstruction</strong><br><span>Junhong Lin, Kangli Wang, Shunzhou Wang, Songlin Fan, Ge Li, Wei Gao</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>164. SimpleVSF: VLM-Scoring Fusion for Trajectory Prediction of End-to-End Autonomous Driving</strong><br><span>Peiru Zheng, Yun Zhao, Zhan Gong, Hong Zhu, Shaohua Wu</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>165. Vision-Centric 4D Occupancy Forecasting and Planning via Implicit Residual World Models</strong><br><span>Jianbiao Mei, Yu Yang, Xuemeng Yang, Licheng Wen, Jiajun Lv, Botian Shi, Yong Liu</span></td>
    ...
    <tr>
      <td style="width: 23%; vertical-align: top;"><strong>166. VDRive: Leveraging Reinforced VLA and Diffusion Policy for End-to-end Autonomous Driving</strong><br><span>Ziang Guo, Zufeng Zhang</span></td>
